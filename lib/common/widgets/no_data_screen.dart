      ...
      child: FooterView(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [
          ...
          Text(
            ...
            style: AlmaraiMedium.copyWith(fontSize: MediaQuery.of(context).size.height*0.0175, color: fromAddress ? Theme.of(context).textTheme.bodyMedium!.color : Theme.of(context).disabledColor),
          ...
          fromAddress ? Text(
            ...
            style: AlmaraiMedium.copyWith(fontSize: MediaQuery.of(context).size.height*0.0175, color: Theme.of(context).disabledColor),
            textAlign: TextAlign.center,
          ) : const SizedBox(),
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text('add_address'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).cardColor)),
                ],
              ),
            ),
          ) : const SizedBox(),
