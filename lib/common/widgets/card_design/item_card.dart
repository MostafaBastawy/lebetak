                      ...
                      child: Stack(children: [
                        ...
                        (item.stock != null && item.stock! < 0) ? Positioned(
                          ...
                          child: Container(
                            ...
                            child: Text('out_of_stock'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).cardColor, fontSize: Dimensions.fontSizeSmall)),
                          ),
                        ) : const SizedBox(),
                        ...
                        child: Stack(clipBehavior: Clip.none, children: [
                          ...
                          Align(
                            ...
                            child: Column(
                              ...
                              (isFood || isShop) ? Text(item.storeName ?? '', style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor))
                                  : Text(item.name ?? '', style: AlmaraiBold, maxLines: 1, overflow: TextOverflow.ellipsis),

                              (isFood || isShop) ? Flexible(
                                child: Text(
                                  item.name ?? '',
                                  style: AlmaraiBold, maxLines: 1, overflow: TextOverflow.ellipsis,
                                ),
                              ...
                              (isFood || isShop) ? item.ratingCount! > 0 ? Row(mainAxisAlignment: isPopularItem ? MainAxisAlignment.center : MainAxisAlignment.start, children: [
                                ...
                                '(${ item.unitType ?? ''})',
                                style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).hintColor),
                              ) : const SizedBox(),
                              ...
                              Text(
                                ...
                                textDirection: TextDirection.ltr, style: AlmaraiMedium,
                              ),
