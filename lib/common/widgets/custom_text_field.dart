  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        widget.showTitle ? Text(widget.titleText, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall)) : const SizedBox(),
        ...
        InkWell(
          ...
          child: TextFormField(
            ...
            style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeLarge),
            ...
            decoration: InputDecoration(
              ...
              hintStyle: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).hintColor),
              filled: true,

              labelStyle : widget.showLabelText ? AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).hintColor) : null,
              errorStyle: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
              ...
              label: widget.showLabelText ? Text.rich(TextSpan(children: [
                ...
                if(widget.required && widget.labelText != null)
                  TextSpan(text : ' *', style: AlmaraiRegular.copyWith(color: Theme.of(context).colorScheme.error, fontSize: Dimensions.fontSizeLarge)),

                if(widget.isEnabled == false)
                  TextSpan(text: widget.fromUpdateProfile ? ' (${'non_changeable'.tr})' : ' (${'non_changeable'.tr})', style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).colorScheme.error)),
                ...
                Container(
                  ...
                  child: Center(
                    child: CodePickerWidget(
                      ...
                      textStyle: AlmaraiRegular.copyWith(
