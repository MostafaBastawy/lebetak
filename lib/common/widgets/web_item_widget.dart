                  ...
                  child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Expanded(child: Column(children: [
                      Stack(children: [
                        ...
                        isStore ? const SizedBox() : Positioned(
                          bottom: 10, right: 10,
                          child: CartCountView(
                            item: item!,
                            index: index,
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      ...
                                      style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall), textDirection: TextDirection.ltr,
                                    ),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        ...
                                        style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeOverSmall, color: Theme.of(context).primaryColor),
                                      ),
                                    ],
                                  ),
                                )
