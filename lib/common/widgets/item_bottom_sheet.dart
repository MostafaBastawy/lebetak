                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.end, children: [
                      ...
                      child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                          ...
                          Expanded(
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              Text(
                                widget.item!.name!, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                              ...
                              InkWell(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    ...
                                    style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor),
                                  ),
                                ),
                              ),
                              ...
                              Text(
                                ...
                                style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge), textDirection: TextDirection.ltr,
                              ),
                              price > priceWithDiscount ? Text(
                                ...
                                style: AlmaraiMedium.copyWith(color: Theme.of(context).disabledColor, decoration: TextDecoration.lineThrough),
                              ) : const SizedBox(),
                            ]),
                          ),
                        ...
                        (widget.item!.description != null && widget.item!.description!.isNotEmpty) ? Column(
                          ...
                          children: [
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              ...
                              Text('description'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                            ...
                            || (Get.find<SplashController>().configModel!.moduleConfig!.module!.vegNonVeg! && Get.find<SplashController>().configModel!.toggleVegNonVeg!)) ? Container(
                                ...
                                child: Get.find<SplashController>().configModel!.moduleConfig!.module!.unit! ? Text(
                                  ...
                                  style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).primaryColor),
                                ) : Row(children: [
                                  Image.asset(widget.item!.veg == 1 ? Images.vegLogo : Images.nonVegLogo, height: 20, width: 20),
                                  const SizedBox(width: Dimensions.paddingSizeSmall),

                                  Text(widget.item!.veg == 1 ? 'veg'.tr : 'non_veg'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
                                ]),
                              ) : const SizedBox(),
                            ...
                            Text(widget.item!.description!, style: AlmaraiRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color?.withValues(alpha: 0.5))),
                            const SizedBox(height: Dimensions.paddingSizeLarge),
                          ],
                        ) : const SizedBox(),
                        ...
                        (widget.item!.nutritionsName != null && widget.item!.nutritionsName!.isNotEmpty) ? Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('nutrition_details'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                            ...
                            Wrap(children: List.generate(widget.item!.nutritionsName!.length, (index) {
                              return Text(
                                ...
                                style: AlmaraiRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color?.withValues(alpha: 0.5)),
                              );
                            })),
                            const SizedBox(height: Dimensions.paddingSizeLarge),
                          ],
                        ...
                        (widget.item!.allergiesName != null && widget.item!.allergiesName!.isNotEmpty) ? Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('allergic_ingredients'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                        ...
                        (widget.item!.genericName != null && widget.item!.genericName!.isNotEmpty) ? Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('generic_name'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                        ...
                        isAvailable ? const SizedBox() : Container(
                          ...
                          child: Column(children: [
                            Text('not_available_now'.tr, style: AlmaraiMedium.copyWith(
                      ...
                      builder: (context) {
                       ...
                       double withAddonCost = cost! + addonsCost;
                        return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text('${'total_amount'.tr}:', style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).primaryColor)),
                          const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                          Row(children: [
                            discount! > 0 ? PriceConverter.convertAnimationPrice(
                              (price * itemController.quantity!) + addonsCost,
                              textStyle: AlmaraiMedium.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall, decoration: TextDecoration.lineThrough),
                            ) : const SizedBox(),
                            const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                            PriceConverter.convertAnimationPrice(
                              withAddonCost,
                              textStyle: AlmaraiBold.copyWith(color: Theme.of(context).primaryColor),
                            ),
                          ]),
                        ]);
                      }
                    ...
                    SafeArea(
                      child: Row(children: [
                          ...
                          Row(children: [
                            ...
                            Text(itemController.quantity.toString(), style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                            QuantityButton(
...
class AddonView extends StatelessWidget {
  ...
  const AddonView({super.key, required this.item, required this.itemController});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Text('addons'.tr, style: AlmaraiMedium),
                  ...
                  child: Row(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                      ...
                      Text(
                        ...
                        style: itemController.addOnActiveList[index] ? AlmaraiMedium : AlmaraiRegular.copyWith(color: Theme.of(context).hintColor),
                      ),
                    ...
                    Text(
                      ...
                      style: itemController.addOnActiveList[index] ? AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeSmall)
                          : AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor),
                    ),
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(item!.choiceOptions![index].title!, style: AlmaraiMedium),
          const SizedBox(height: Dimensions.paddingSizeSmall),
          Container(
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
...
class NewVariationView extends StatelessWidget {
  ...
  const NewVariationView({super.key, required this.item, required this.itemController, required this.discount, required this.discountType, required this.showOriginalPrice});
        ...
        return Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [
              Text(item!.foodVariations![index].name!, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
            ...
            item!.foodVariations![index].multiSelect! ? Text(
              ...
              style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor),
            ) : Text(
              'select_one'.tr,
              style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).primaryColor),
            ),
                      ...
                      child: Row(children: [
                        ...
                        Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                          ...
                          Text(
                            ...
                            maxLines: 1, overflow: TextOverflow.ellipsis,
                            style: itemController.selectedVariations[index][i]! ? AlmaraiMedium : AlmaraiRegular.copyWith(color: Theme.of(context).hintColor),
                          ),
                        ...
                        showOriginalPrice ? Text(
                          ...
                          maxLines: 1, overflow: TextOverflow.ellipsis, textDirection: TextDirection.ltr,
                          style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor, decoration: TextDecoration.lineThrough),
                        ) : const SizedBox(),
                        ...
                        Text(
                          ...
                          maxLines: 1, overflow: TextOverflow.ellipsis, textDirection: TextDirection.ltr,
                          style: itemController.selectedVariations[index][i]! ? AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall)
                              : AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor),
                        ),
