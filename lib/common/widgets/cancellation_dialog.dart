              ...
              return !orderController.isLoading ? Row(
                ...
                TextButton(
                  ...
                  child: Text('no'.tr, textAlign: TextAlign.center,
                    style: AlmaraiBold.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color),
                  ),
                ),
                ...
                Container(
                  ...
                  child: Center(child: Text('yes'.tr,style: AlmaraiRegular.copyWith(color: Theme.of(context).cardColor),)),
                ),
