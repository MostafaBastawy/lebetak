      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Container(
          ...
          child: Row( mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Text('menu'.tr, style: AlmaraiBold.copyWith(fontSize: 20 )),
                  ...
                  child: InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Row(children: [
                        ...
                        Expanded(child: Text(_menuList[index].title, style: AlmaraiMedium, overflow: TextOverflow.ellipsis, maxLines: 1)),
