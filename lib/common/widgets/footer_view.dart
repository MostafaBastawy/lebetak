          ...
          Container(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Expanded(flex: 4, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text('subscribe_to_out_new_channel_to_get_latest_updates'.tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                const SizedBox(height: Dimensions.paddingSizeSmall),
                ...
                Container(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(child: TextField(
                      ...
                      expands: false,
                      style: AlmaraiMedium.copyWith(color: Colors.black, fontSize: Dimensions.fontSizeExtraSmall),
                      decoration: InputDecoration(
                        hintText: 'your_email_address'.tr,
                        hintStyle: AlmaraiRegular.copyWith(color: Colors.grey, fontSize: Dimensions.fontSizeExtraSmall),
                    ...
                    GetBuilder<SplashController>(builder: (splashController) {
                      return InkWell(
                        ...
                        child: Container(
                          ...
                          child: !splashController.isLoading ? Text('subscribe'.tr, style: AlmaraiRegular.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeExtraSmall))
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Column(children: [
                          ...
                          Text('send_us_mail'.tr, style: AlmaraiBold),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          ...
                          InkWell(
                            ...
                            child: Text(_config.email ?? '', style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
                          ),
                        ...
                        Column(children: [
                          ...
                          Text('contact_us'.tr, style: AlmaraiBold),
                          const SizedBox(height: Dimensions.paddingSizeSmall),

                          Text(_config.phone ?? '', style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
                        ...
                        Column(children: [
                          ...
                          Text('find_us_here'.tr, style: AlmaraiBold),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          ...
                          SizedBox(
                            ...
                            child: Text(
                              ...
                              style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall),
                            ),
                          ),
            ...
            child: Center(
              child: SizedBox(
                ...
                child: Center(
                  child: Text(
                    '© ${_config.footerText ?? ''}',
                    style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, fontWeight: FontWeight.w400),
                  ),
                ),
              ),
            ),
  ...
  Widget build(BuildContext context) {
    return TextHover(builder: (hovered) {
      return InkWell(
        ...
        child: Text(title, style: hovered ? AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeExtraSmall)
            : AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
      );
    });
  }
}