                    ...
                    languageList.add(DropdownItem<int>(value: index, child: Row(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(AppConstants.languages[index].languageName!, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall),),
                        ),
                      ],
                    )));
                  }
                  ...
                  for(int index=0; index<AppConstants.joinDropdown.length; index++) {
                    if(index != 0) {
                      joinUsList.add(DropdownItem<int>(value: index, child: Padding(
                        ...
                        child: Text(AppConstants.joinDropdown[index].tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, fontWeight: FontWeight.w100, color: Get.find<ThemeController>().darkTheme ? Colors.white : Colors.black)),
                      )));
                    }
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                ...
                                style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall),
                              ),
                            ),
                          ],
                        ),
                      ...
                      child: CustomDropdown<int>(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(AppConstants.joinDropdown[0].tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, fontWeight: FontWeight.w100, color: Get.find<ThemeController>().darkTheme ? Colors.white : Colors.black)),
                          ],
                        ),
                      ),
              ...
              return InkWell(
                ...
                child: Container(
                  ...
                  child: Row(children: [
                    ...
                    const SizedBox(width: Dimensions.paddingSizeSmall),
                    Text(authController.isLoggedIn() ? 'profile'.tr : 'sign_in'.tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, fontWeight: FontWeight.w100)),
                  ]),
                ),
              );
            }),
  ...
  Widget build(BuildContext context) {
    return TextHover(builder: (hovered) {
      return InkWell(
        ...
        child: Text(title, style: AlmaraiRegular.copyWith(color: hovered ? Theme.of(context).primaryColor : null)),
      );
    });
  }
}
            ...
            (isCart && cartController.cartList.isNotEmpty) ? Positioned(
              ...
              child: Container(
                ...
                child: Text(
                  ...
                  style: AlmaraiRegular.copyWith(fontSize: 12, color: Theme.of(context).cardColor),
                ),
              ),
            ) : const SizedBox()
          ]);
