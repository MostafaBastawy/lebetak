                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: Center(child: Text('address'.tr, style: AlmaraiMedium)),
                      ),
                              ...
                              Container(
                                ...
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    ...
                                    Text(
                                      'label_as'.tr,
                                      style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyMedium!.color),
                                    ),
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                Text(index == 0 ? 'home'.tr : index == 1 ? 'office'.tr : 'others'.tr,
                                                  style: AlmaraiRegular.copyWith(color: locationController.addressTypeIndex == index ? Theme.of(context).cardColor : Theme.of(context).disabledColor),
                                                )
                                              ],
                                            ),
                                          ),
