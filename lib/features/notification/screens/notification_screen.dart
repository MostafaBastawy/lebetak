                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            addTitle ? Padding(
                              ...
                              child: Text(
                                ...
                                style: AlmaraiMedium.copyWith(color: Theme.of(context).hintColor),
                              ),
                            ) : const SizedBox(),
                                    ...
                                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          ...
                                          style: AlmaraiBold.copyWith(color: isSeen ? Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.5) : Theme.of(context).textTheme.bodyLarge?.color,
                                    ...
                                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      Expanded(
                                        child: Text(
                                          ...
                                          style: AlmaraiRegular.copyWith(color: isSeen ? Theme.of(context).disabledColor : Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.7)),
                                        ),
                                      ),
                                      const SizedBox(width: Dimensions.paddingSizeSmall),
