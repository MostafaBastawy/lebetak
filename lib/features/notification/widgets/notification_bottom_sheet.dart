          ...
          child: SingleChildScrollView(
            child: Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text(notificationModel.data?.title ?? '', style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                const SizedBox(height: Dimensions.paddingSizeExtraSmall),

                Text(notificationModel.data?.description ?? '', style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
