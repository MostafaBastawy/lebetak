  ...
  Widget build(BuildContext context) {
    ...
    return Stack(children: [
      ...
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          // isDesktop ? Text('general_info'.tr, style: AlmaraiMedium) : const SizedBox(),
        ...
        parcel || prescriptionOrder || (orderController.orderDetails!.isNotEmpty && orderController.orderDetails![0].itemDetails!.moduleType == 'grocery')
          ...
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
              ...
              Text('general_info'.tr, style: AlmaraiMedium),
              const SizedBox(height: Dimensions.paddingSizeLarge),

              Row(children: [
                Text(parcel ? 'delivery_id'.tr : 'order_id'.tr, style: AlmaraiRegular),
                const Expanded(child: SizedBox()),

                Text('#${order.id}', style: AlmaraiBold),
              ]),
              Divider(height: Dimensions.paddingSizeLarge, color: Theme.of(context).disabledColor.withValues(alpha: 0.30)),

              Row(children: [
                Text('order_date'.tr, style: AlmaraiRegular),
                const Expanded(child: SizedBox()),
              ...
              order.scheduled == 1 ? Row(children: [
                Text('${'scheduled_at'.tr}:', style: AlmaraiRegular),
                const Expanded(child: SizedBox()),
                Text(DateConverter.dateTimeStringToDateTime(order.scheduleAt!), style: AlmaraiMedium),
              ]) : const SizedBox(),
              ...
              Get.find<SplashController>().configModel!.orderDeliveryVerification! ? Row(children: [
                Text('${'delivery_verification_code'.tr}:', style: AlmaraiRegular),
                const Expanded(child: SizedBox()),
                Text(order.otp!, style: AlmaraiMedium),
              ]) : const SizedBox(),
              Divider(height: Dimensions.paddingSizeLarge, color: Theme.of(context).disabledColor.withValues(alpha: 0.30)),

              Row(children: [
                Text(order.orderType!.tr, style: AlmaraiMedium),
                const Expanded(child: SizedBox()),
                Container(
                  ...
                  child: Text( order.paymentMethod == 'cash_on_delivery' ? 'cash_on_delivery'.tr
                    ...
                    style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeExtraSmall),
                  ),
                ),
              ]),
              Divider(height: Dimensions.paddingSizeLarge, color: Theme.of(context).disabledColor.withValues(alpha: 0.30)),
              ...
              Padding(
                ...
                child: Row(children: [
                  Text('${parcel ? 'charge_pay_by'.tr : 'item'.tr}:', style: AlmaraiRegular),
              ...
              Get.find<SplashController>().getModuleConfig(order.moduleType).newVariation! ? Column(children: [
                ...
                Row(children: [
                  Text('${'cutlery'.tr}: ', style: AlmaraiRegular),
                  const Expanded(child: SizedBox()),
              ...
              order.unavailableItemNote != null ? Column(
                children: [
                  ...
                  Row(children: [
                    Text('${'unavailable_item_note'.tr}: ', style: AlmaraiMedium),
              ...
              order.deliveryInstruction != null ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                RichText(
                  text: TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(text: order.deliveryInstruction!, style: AlmaraiRegular
                        )
                      ]
                  ),
                ),
              ...
              order.orderStatus == 'canceled' ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Divider(height: Dimensions.paddingSizeLarge, color: Theme.of(context).disabledColor.withValues(alpha: 0.30)),
                Text('${'cancellation_note'.tr}:', style: AlmaraiMedium),
              ...
              (order.orderStatus == 'refund_requested' || order.orderStatus == 'refund_request_canceled') ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                order.orderStatus == 'refund_requested' ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  RichText(text: TextSpan(children: [
                    TextSpan(text: '${'refund_note'.tr}:', style: AlmaraiMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color)),
                    TextSpan(text: '(${(order.refund != null) ? order.refund!.customerReason : ''})', style: AlmaraiRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color)),
                  ])),
                  const SizedBox(height: Dimensions.paddingSizeSmall),
                  ...
                  Text('${'refund_cancellation_note'.tr}:', style: AlmaraiMedium),
                  const SizedBox(height: Dimensions.paddingSizeSmall),
          ...
          !isDesktop ? (parcel || orderController.orderDetails!.isNotEmpty) ? Container(
            ...
            child: parcel ? Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
              ...
              Text('item_info'.tr, style: AlmaraiMedium),
              const SizedBox(height: Dimensions.paddingSizeSmall),
          ...
          (isDesktop && Get.find<SplashController>().getModuleConfig(order.moduleType).orderAttachment! && order.orderAttachmentFullUrl != null
              && order.orderAttachmentFullUrl!.isNotEmpty )  ? Text('prescription'.tr, style: AlmaraiMedium) :  const SizedBox(),
          ...
          (Get.find<SplashController>().getModuleConfig(order.moduleType).orderAttachment! && order.orderAttachmentFullUrl != null && order.orderAttachmentFullUrl!.isNotEmpty) ? Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              !isDesktop ? Text('prescription'.tr, style: AlmaraiRegular) : const SizedBox(),
              !isDesktop ? const SizedBox(height: Dimensions.paddingSizeSmall) : const SizedBox(),
              ...
              (order.orderNote  != null && order.orderNote!.isNotEmpty) ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('additional_note'.tr, style: AlmaraiRegular),
                const SizedBox(height: Dimensions.paddingSizeSmall),
                ...
                InkWell(
                  ...
                  child: Text(
                    ...
                    style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor),
                  ),
                ),
                const SizedBox(height: Dimensions.paddingSizeLarge),
              ]) : const SizedBox(),
        ...
        (order.orderStatus == 'delivered' && order.orderProofFullUrl != null && order.orderProofFullUrl!.isNotEmpty) ? Container(
          ...
          padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeLarge, vertical: Dimensions.paddingSizeSmall),
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('order_proof'.tr, style: AlmaraiRegular),
            const SizedBox(height: Dimensions.paddingSizeSmall),
          ...
          (order.deliveryMan != null && isDesktop) ? Text('delivery_man_details'.tr, style: AlmaraiMedium) :  const SizedBox(),
          ...
          order.deliveryMan != null ? Container(
            ...
            padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeLarge, vertical: Dimensions.paddingSizeSmall),
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('delivery_man_details'.tr, style: AlmaraiMedium),
          ...
          (!parcel && isDesktop) ? Text('delivery_details'.tr, style: AlmaraiMedium) :  const SizedBox(),
          ...
          (!parcel && order.store != null) ? Container(
            ...
            padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeLarge, vertical: Dimensions.paddingSizeSmall),
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              !isDesktop ? Text('delivery_details'.tr, style: AlmaraiMedium) : const SizedBox(),
              !isDesktop ? const SizedBox(height: Dimensions.paddingSizeSmall) : const SizedBox(),
          ...
          isDesktop ? Text(parcel ? 'parcel_category'.tr : Get.find<SplashController>().getModuleConfig(order.moduleType).showRestaurantText! ? 'restaurant_details'.tr : 'store_details'.tr, style: AlmaraiMedium)  : const SizedBox(),
          isDesktop ? const SizedBox(height: Dimensions.paddingSizeDefault) : const SizedBox(),
          Container(
            decoration: BoxDecoration(
              color: Theme.of(context).cardColor,
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              (parcel && order.parcelCategory == null) ? Text(
                  'no_parcel_category_data_found'.tr, style: AlmaraiMedium
                ...
                && (parcel || (orderController.orderDetails!.isNotEmpty && orderController.orderDetails![0].itemCampaignId == null))) ? InkWell(
                  ...
                  child: Container(
                    ...
                    child: Text('refund_this_order'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor)),
                  ),
                ) : const SizedBox(),
          ...
          isDesktop ? Row(
            ...
            children: [
              Text('payment_method'.tr, style: AlmaraiMedium),
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              !isDesktop ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                order.paymentMethod == 'offline_payment' || (order.paymentMethod == 'partial_payment' && orderController.trackModel!.offlinePayment != null) ? Text(
                  orderController.trackModel!.offlinePayment != null ? orderController.trackModel!.offlinePayment!.data!.status!.tr : '',
                  style: AlmaraiMedium.copyWith(color: (orderController.trackModel!.offlinePayment != null ? orderController.trackModel!.offlinePayment!.data!.status.toString() == 'denied' : false) ? Colors.red : Theme.of(context).primaryColor),
                ) : const SizedBox(),
                ...
                Expanded(
                  child: Text(
                    order.paymentMethod == 'cash_on_delivery' ? 'cash'.tr
                        ...
                        : order.paymentMethod == 'partial_payment' ? 'partial_payment'.tr
                        : 'digital'.tr,
                    style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor),
                  ),
                ),
      ...
      child: ExpansionTile(
        ...
        children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Text('seller_payment_info'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor)),
            const SizedBox(),
          ]),
          ...
          orderController.trackModel!.offlinePayment != null ? ListView.builder(
            ...
            itemBuilder: (context, index){
              return Padding(
                ...
                child: Row(children: [
                  Text('${orderController.trackModel!.offlinePayment!.methodFields![index].inputName.toString().replaceAll('_', ' ')} : ', style: AlmaraiRegular),
                  Text('${orderController.trackModel!.offlinePayment!.methodFields![index].inputData}', style: AlmaraiRegular),
                ]),
              );
            },
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Text('my_payment_info'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor)),
            ...
            (ongoing && orderController.trackModel!.offlinePayment != null && orderController.trackModel!.offlinePayment!.data!.status != 'verified') ? InkWell(
              ...
              child: Text('edit_details'.tr, style: AlmaraiBold.copyWith(color: Theme.of(context).primaryColor)),
            ) : const SizedBox(),
          ]),
          const SizedBox(height: Dimensions.paddingSizeDefault),
          ...
          orderController.trackModel!.offlinePayment != null ? ListView.builder(
            ...
            itemBuilder: (context, index){
              ...
              return Padding(
                padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeExtraSmall),
                child: Row(children: [
                  Text('${data.userInput.toString().replaceAll('_', ' ')}: ', style: AlmaraiRegular),
                  Text(data.userData.toString(), style: AlmaraiRegular),
                ]),
              );
            },
          ) : const SizedBox(),
