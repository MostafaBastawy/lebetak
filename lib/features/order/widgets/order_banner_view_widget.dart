  ...
  Widget build(BuildContext context) {
    return Column(children: [
      DateConverter.isBeforeTime(order.scheduleAt) && Get.find<SplashController>().getModuleConfig(order.moduleType).newVariation! ? ongoing ? Column(children: [
        ...
        Text('your_food_will_delivered_within'.tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).disabledColor)),
        ...
        Center(
          child: Row(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text(
              ...
              style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge), textDirection: TextDirection.ltr,
            ),
            const SizedBox(width: Dimensions.paddingSizeExtraSmall),

            Text('min'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).primaryColor)),
          ]),
        ),
