                              ...
                              Row(children: [
                                ...
                                Stack(children: [
                                  ...
                                  isParcel ? Positioned(left: 0, top: 10, child: Container(
                                    ...
                                    child: Text('parcel'.tr, style: AlmaraiMedium.copyWith(
                                  ...
                                  isPrescription ? Positioned(left: 0, top: 10, child: Container(
                                    ...
                                    child: Text('prescription'.tr, style: AlmaraiMedium.copyWith(
                                ...
                                Expanded(
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    Row(children: [
                                      ...
                                      Text('#${paginatedOrderModel.orders![index].id}', style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
                                    ]),
                                    ...
                                    ResponsiveHelper.isDesktop(context) ? Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text(paginatedOrderModel.orders![index].orderStatus!.tr, style: AlmaraiMedium.copyWith(
                                  ...
                                  isRunning ? InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(children: [
                                        ...
                                        const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                        Text(isParcel ? 'track_delivery'.tr : 'track_order'.tr, style: AlmaraiMedium.copyWith(
