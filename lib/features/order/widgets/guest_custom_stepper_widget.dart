  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      ListTile(
        ...
        title: Text(title!, style: isComplete ? AlmaraiMedium.copyWith(
          fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).primaryColor,
        ) : AlmaraiRegular.copyWith(
          fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).disabledColor,
        )),
        subtitle: subTitle != null ? Text(subTitle!, style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall)) : const SizedBox(),
