  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: (!takeAway && track.deliveryMan == null) ? Padding(
        padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
        child: Text(
          'delivery_man_not_assigned'.tr, style: AlmaraiMedium, textAlign: TextAlign.center,
        ),
      ) : Column(children: [

        Text('trip_route'.tr, style: AlmaraiMedium),
        ...
        Row(children: [
          ...
          Expanded(
            flex: 5,
            child: (takeAway && track.orderType != 'parcel') ? Text(track.store != null ? track.store!.address! : '', style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
        ...
        Row(children: [
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: Text(
                'call'.tr,
                style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).cardColor),
              ),
            ),
          ),
          const SizedBox(width: Dimensions.paddingSizeSmall),
