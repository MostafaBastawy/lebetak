              ...
              children: [
                ...
                haveTaxiModule && !ResponsiveHelper.isDesktop(context) ? Container(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Text('my_orders'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Container(
                              ...
                              child: CustomInkWell(
                                ...
                                child: Text(type[index].tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: selected ? Colors.white : Theme.of(context).textTheme.bodyLarge!.color!.withValues(alpha: 0.7))),
                              ),
                            );
                          }),
                    ),
                    ...
                    ResponsiveHelper.isDesktop(context) ? Container(
                      ...
                      child: Column(children: [
                        ResponsiveHelper.isDesktop(context) ? Center(child: Padding(
                          ...
                          child: Text('my_orders'.tr, style: AlmaraiMedium),
                        )) : const SizedBox(),
