        ...
        children: [
              ...
              child: Row(
                children: [
                  Flexible(
                    child: Text(
                      item?.name ?? '',
                      style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeOverLarge),
                  ...
                  || (Get.find<SplashController>().configModel!.moduleConfig!.module!.vegNonVeg! && Get.find<SplashController>().configModel!.toggleVegNonVeg!)) ? Text(
                    ...
                    style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor),
                  ) : const SizedBox(),
                ],
              ),
            ),
          ...
          Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
            Container(
              ...
              child: Text(inStock ? 'out_of_stock'.tr : 'in_stock'.tr, style: AlmaraiRegular.copyWith(
                color: Theme.of(context).primaryColor,
          ...
          InkWell(
            ...
            child: Padding(
              ...
              child: Text(
                item!.storeName!,
                style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor),
              ),
            ),
          ),
          //const SizedBox(height: Dimensions.paddingSizeSmall),
          ...
          Row(children: [
            ...
            Text(
              ...
              style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge), textDirection: TextDirection.ltr,
            ),
          ]),
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(
                  '${PriceConverter.convertPrice(startingPrice, discount: discount, discountType: discountType)}'
                      '${endingPrice!= null ? ' - ${PriceConverter.convertPrice(endingPrice, discount: discount, discountType: discountType)}' : ''}',
                  style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeLarge), textDirection: TextDirection.ltr,
                ),
                const SizedBox(height: 5),
                ...
                discount! > 0 ? Text(
                  ...
                  style: AlmaraiRegular.copyWith(color: Theme.of(context).hintColor, decoration: TextDecoration.lineThrough),
                ) : const SizedBox(),
                SizedBox(height: discount > 0 ? 5 : 0),

                !isCampaign ? Row(children: [
                  Text(item!.avgRating!.toStringAsFixed(1), style: AlmaraiRegular.copyWith(
