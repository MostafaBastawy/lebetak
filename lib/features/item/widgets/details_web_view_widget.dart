                      ...
                      children: [
                        ...
                        (itemController.item!.description != null && itemController.item!.description!.isNotEmpty) ? Column(
                          ...
                          children: [
                            ...
                            Text('description'.tr, style: AlmaraiMedium),
                            ...
                            itemController.item!.description!.length > 150 ? InkWell(
                              ...
                              child: Text(
                                ...
                                style: AlmaraiRegular.copyWith(color: Theme.of(context).primaryColor),
                              ),
                            ) : const SizedBox(),
                        ...
                        (itemController.item!.nutritionsName != null && itemController.item!.nutritionsName!.isNotEmpty) ? Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('nutrition_details'.tr, style: AlmaraiMedium),
                            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                        ...
                        (itemController.item!.allergiesName != null && itemController.item!.allergiesName!.isNotEmpty) ? Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('allergic_ingredients'.tr, style: AlmaraiMedium),
                            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                        ...
                        itemController.item!.isPrescriptionRequired! ? Container(
                          ...
                          child: Text(
                            ...
                            style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).colorScheme.error),
                          ),
                        ) : const SizedBox(),
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Text(itemController.item!.choiceOptions![index].title!, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                              const SizedBox(height: Dimensions.paddingSizeExtraSmall),

                              Text('select_one'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall)),
                              const SizedBox(height: Dimensions.paddingSizeSmall),
                        ...
                        GetBuilder<CartController>(
                          builder: (cartController) {
                            return Row(children: [
                              Text('${'total_amount'.tr}:', style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                              ...
                              Text(PriceConverter.convertPrice(itemController.cartIndex != -1
                                  ...
                                  : priceWithAddOns), textDirection: TextDirection.ltr, style: AlmaraiBold.copyWith(
