                    ...
                    child: Center(child: SizedBox(width: Dimensions.webMaxWidth, child: Column(
                      ...
                      children: [
                        ...
                        GetBuilder<CartController>(
                          builder: (cartController) {
                            return Row(children: [
                              Text('quantity'.tr, style:AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                        ...
                        Row(children: [
                          ...
                          Text(
                            ...
                            style:AlmaraiBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeLarge),
                          ),
                        ]),
                        ...
                        (itemController.item!.description != null && itemController.item!.description!.isNotEmpty) ? Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                            Text(itemController.item!.description!, style: AlmaraiRegular),
                            const SizedBox(height: Dimensions.paddingSizeLarge),
                          ],
                        ) : const SizedBox(),
