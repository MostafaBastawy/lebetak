      ...
      builder: (profileController) {
        return Column(
          ...
          children: [
            ...
            Stack(children: [
              Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                  Text('wallet_amount'.tr,style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).cardColor)),
                  const SizedBox(height: Dimensions.paddingSizeSmall),

                  Row(children: [
                    Text(
                      PriceConverter.convertPrice(profileController.userInfoModel!.walletBalance), textDirection: TextDirection.ltr,
                      style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeOverLarge, color: Theme.of(context).cardColor),
                    ),
            ...
            isDesktop ? Text('how_to_use'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)) : const SizedBox(),
            isDesktop ? const SizedBox(height: Dimensions.paddingSizeDefault) : const SizedBox(),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text('earn_money_to_your_wallet_by_completing_the_offer_challenged'.tr, style: AlmaraiRegular),
                Text('convert_your_loyalty_points_into_wallet_money'.tr, style: AlmaraiRegular),
                Text('amin_also_reward_their_top_customers_with_wallet_money'.tr, style: AlmaraiRegular),
                Text('send_your_wallet_money_while_order'.tr, style: AlmaraiRegular),
              ],
            ),
          ),
