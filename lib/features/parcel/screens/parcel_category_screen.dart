              ...
              child: SingleChildScrollView(
                ...
                child: FooterView(child: SizedBox(width: Dimensions.webMaxWidth,
                    child: Column(crossAxisAlignment: ResponsiveHelper.isDesktop(context) ? CrossAxisAlignment.center : CrossAxisAlignment.start, children: [
                      ...
                      Text('bringing_happiness_from_door_to_door'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                      const SizedBox(height: Dimensions.paddingSizeExtraSmall),

                      Text('ready_to_send_something_special'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor)),
                      ...
                      Align(
                        ...
                        child: Text('easiest_way_to_get_services'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                      ),
                      const SizedBox(height: Dimensions.paddingSizeLarge),
