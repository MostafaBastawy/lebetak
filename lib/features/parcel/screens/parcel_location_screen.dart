                      ...
                      TabBar(
                        ...
                        tabs: [
                          Padding(
                            ...
                            child: Text(
                              'sender_info'.tr,
                              style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: parcelController.isSender ? Theme.of(context).primaryColor : Theme.of(context).textTheme.bodyMedium!.color),
                            ),
                          ),
                          Text(
                            'receiver_info'.tr,
