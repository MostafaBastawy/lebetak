              ...
              child: FooterView(child: SizedBox(width: Dimensions.webMaxWidth, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  child: Container(
                    ...
                    child: Row(children: [
                      ...
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text(widget.parcelCategory.name!, style: AlmaraiBold.copyWith(color: Theme.of(context).primaryColor)),
                ...
                CardWidget(child: Row(children: [
                  Expanded(child: Row(children: [
                    ...
                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text('distance'.tr, style: AlmaraiRegular),
                      Text(
                        parcelController.distance == -1 ? 'calculating'.tr : '${parcelController.distance!.toStringAsFixed(2)} ${'km'.tr}',
                        style: AlmaraiBold.copyWith(color: Theme.of(context).primaryColor),
                      ),
                    ]),
                  ])),
                  Expanded(child: Row(children: [
                    ...
                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Text(
                        ...
                        style: AlmaraiBold.copyWith(color: Theme.of(context).primaryColor), textDirection: TextDirection.ltr,
                      ),
                    ]),
                  ]))
                ])),
                  ...
                  child: Padding(
                    ...
                    child: Column(children: [
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        Text("add_more_delivery_instruction".tr, style: AlmaraiMedium),
                        ...
                        Flexible(
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                              ...
                              children: [
                                Flexible(
                                  child: Text(
                                    ...
                                    style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor), maxLines: 1, overflow: TextOverflow.ellipsis,
                                  ),
                                ),
                                const SizedBox(width: Dimensions.paddingSizeSmall),
                            ...
                            parcelController.customNote!.isNotEmpty ? Text(
                              ...
                              style: AlmaraiMedium.copyWith(color: Theme.of(context).disabledColor),
                            ) : const SizedBox(),
                ...
                (Get.find<SplashController>().configModel!.dmTipsStatus == 1) ? Container(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Text('delivery_man_tips'.tr, style: AlmaraiMedium),
                    const SizedBox(height: Dimensions.paddingSizeSmall),
                    ...
                    parcelController.selectedTips == AppConstants.tips.length-1 ? const SizedBox() : ListTile(
                      ...
                      title: Text('save_for_later'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor)),
                ...
                Text('charge_pay_by'.tr, style: AlmaraiMedium),
                const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                Row(children: [
                  Expanded(child: InkWell(
                    ...
                    child: Row(children: [
                      ...
                      Text(parcelController.payerTypes[0].tr, style: AlmaraiRegular),
                    ]),
                  )),
                  _isCashOnDeliveryActive! ? Expanded(child: InkWell(
                    ...
                    child: Row(children: [
                      ...
                      Text(parcelController.payerTypes[1].tr, style: AlmaraiRegular),
                    ]),
                  )) : const SizedBox(),
                ]),
                const SizedBox(height: Dimensions.paddingSizeLarge),
                ...
                (_isDigitalPaymentActive! && parcelController.payerIndex == 0) ? Column(children: [
                  Row(children: [
                    Text('pay_via_online'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                    Text(
                ...
                Text('order_summary'.tr, style: AlmaraiMedium),
                const SizedBox(height: Dimensions.paddingSizeSmall),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Text(
                    parcelController.distance == -1 ? 'calculating'.tr : PriceConverter.convertPrice(charge),
                    style: AlmaraiRegular.copyWith(color: parcelController.distance == -1 ? Colors.red : Theme.of(context).textTheme.bodyMedium!.color),
                  ),
                ]),
                ...
                (Get.find<SplashController>().configModel!.dmTipsStatus == 1) ? Row(
                  ...
                  children: [
                    ...
                    Text('(+) ${PriceConverter.convertPrice(dmTips)}', style: AlmaraiRegular, textDirection: TextDirection.ltr),
                  ],
                ) : const SizedBox.shrink(),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Text('total_amount'.tr, style: AlmaraiMedium),
                  PriceConverter.convertAnimationPrice(total, textStyle: AlmaraiMedium),
                ]),
