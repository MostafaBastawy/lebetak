          ...
          child: parcelController.parcelInstructionList != null ? SingleChildScrollView(
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                parcelController.parcelInstructionList!.isNotEmpty ? Text("choose_delivery_instructions".tr, style: AlmaraiMedium) : const SizedBox(),
              ...
              Row(
                children: [
                  parcelController.parcelInstructionList!.isNotEmpty ? Text("or".tr, style: AlmaraiMedium) : const SizedBox(),
                  SizedBox(width: parcelController.parcelInstructionList!.isNotEmpty ? Dimensions.paddingSizeExtraSmall : 0),

                  Text("add_custom_note".tr, style: AlmaraiMedium),
                ],
              ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(child: Text(title, style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor), maxLines: 2, overflow: TextOverflow.ellipsis)),
