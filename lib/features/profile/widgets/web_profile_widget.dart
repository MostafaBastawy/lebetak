                    ...
                    Container(
                      ...
                      child: Align(
                        ...
                        child: Padding(
                          ...
                          child: Text('profile'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)))),
                    ),
                      ...
                      child: Align(
                        ...
                        child: InkWell(
                          ...
                          child: Row(mainAxisSize: MainAxisSize.min, children: [
                              ...
                              Text('delete_account'.tr , style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                            ],
                          ))),
                    ),
                  ...
                  child: Container(
                    ...
                    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      Text(
                        ...
                        style: AlmaraiMedium.copyWith(fontSize: ResponsiveHelper.isDesktop(context) ? Dimensions.fontSizeDefault : Dimensions.fontSizeExtraLarge),
                      ),
                      const SizedBox(height: Dimensions.paddingSizeSmall),
                      Text('since_joining'.tr, style: AlmaraiRegular.copyWith(
