      ...
      child: GetBuilder<AuthController>(builder: (authController) {
        return SafeArea(
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text('are_you_sure'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge), textAlign: TextAlign.center),
            ...
            Padding(
              ...
              child: Text(
                ...
                style: AlmaraiRegular.copyWith(color: Theme.of(context).hintColor), textAlign: TextAlign.center,
              ),
            ),
