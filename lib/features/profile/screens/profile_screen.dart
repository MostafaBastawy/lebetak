                      ...
                      Padding(
                        ...
                        child: SafeArea(
                          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            ...
                            Text('profile'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                        ...
                        child: Row(children: [
                          ...
                          isLoggedIn ? InkWell(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                'login'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).cardColor),
                              ),
                            ),
                          )
                        ...
                        child: Container(
                          ...
                          child: Column(children: [
                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                              Text('${'version'.tr}:', style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
                              const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                              Text(AppConstants.appVersion.toStringAsFixed(2), style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
                            ]),
                          ]),
                        ),
                      )
