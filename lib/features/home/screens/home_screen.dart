...
import '../../../helper/taxi_helper.dart';
import '../../dashboard/widgets/parcel_bottom_sheet_widget.dart';
import '../../rental_module/common/widgets/taxi_cart_widget.dart';
import '../../rental_module/rental_cart_screen/taxi_cart_screen.dart';
                        ...
                        child: Row(
                          children: [
                            ...
                            (splashController.module != null &&
                              ...
                              child: Image.asset(Images.moduleIcon, height: 35, width: 35, color: Theme.of(context).textTheme.bodyLarge!.color),
                            )
                                : const SizedBox(),
                            SizedBox(
                                  ...
                                  child: GetBuilder<LocationController>(builder: (locationController) {
                                    return Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        border: Border.all(color: Colors.black87/*Theme.of(context).disabledColor.withOpacity(0.2)*/),
                                      ),
                                      child: Column(
                                        ...
                                        children: [
                                          /*Text(
                                            ...
                                            style: AlmaraiMedium.copyWith(
                                              ...
                                              fontSize: /*Dimensions.fontSizeDefault8*/5,
                                            ),
                                            maxLines: 1,
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Expanded( // ← يجعل النص لا يتجاوز و يظهر "..."
                                                child: Text(
                                                  AddressHelper.getUserAddressFromSharedPref()!.address ?? '',
                                                  style: AlmaraiRegular.copyWith(
                                                    color: Colors.black87/*Theme.of(context).disabledColor*/,
                                              ...
                                              const SizedBox(width: 4),
                                              Icon(Icons.expand_more, color: Colors.black87/*Theme.of(context).disabledColor*/, size: 18),
                                            ],
                                          ),
                                        ],
                                      ),
                            ...
                            GetBuilder<SplashController>(builder: (splashController) {
                              ...
                              bool isTaxiWithCache = ((splashController.module != null &&
                                  ...
                                  (splashController.cacheModule != null &&
                                      splashController.cacheModule!.moduleType.toString() == AppConstants.taxi)) &&
                              ...
                              return InkWell(
                                  ...
                                  if (isParcel) {
                                    showModalBottomSheet(
                                      ...
                                      builder: (con) => ParcelBottomSheetWidget(
                                        parcelCategoryList: Get.find<ParcelController>().parcelCategoryList,
                                      ),
                                    );
                                ...
                                child: Padding(
                                  ...
                                  child: isTaxiWithCache
                                      ? TaxiCartWidget(color: Theme.of(context).textTheme.bodyLarge!.color, size: 22)
                                      : isParcel
                                      ? Icon(CupertinoIcons.add, size: 28, color: Theme.of(context).textTheme.bodyLarge!.color)
                                      : CartWidget(color: Theme.of(context).textTheme.bodyLarge!.color, size: 22),
                                ),
                              );
                            }),
                          ],
