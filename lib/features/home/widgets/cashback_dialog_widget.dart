            ...
            children: [
              ...
              homeController.cashBackOfferList!.isNotEmpty ? Container(
                ...
                child: Column(
                          ...
                          return Container(
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              Container(
                                ...
                                child: Text(homeController.cashBackOfferList![index].title??'', style: AlmaraiBold,),
                              ),
                              ...
                              // Text('Min Spent \$500 |Valid till 22 Sept, 2023', style: AlmaraiRegular.copyWith(color: Theme.of(context).hintColor)),
                  ...
                  padding: const EdgeInsets.all(Dimensions.paddingSizeExtraSmall),
                  child: Text('no_offer_available'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).hintColor)),
                ),
