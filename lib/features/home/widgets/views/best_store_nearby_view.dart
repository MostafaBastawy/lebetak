            ...
            isPharmacy ? SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    padding: const EdgeInsets.only(right: Dimensions.paddingSizeDefault, top: Dimensions.paddingSizeDefault, bottom: Dimensions.paddingSizeExtraSmall),
                            ...
                            Container(
                              ...
                              child: CustomInkWell(
                                ...
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                        ...
                                        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                          ...
                                          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                            ...
                                            storeList[index].ratingCount! > 0 ? Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                                              ...
                                              Text(storeList[index].avgRating!.toStringAsFixed(1), style: AlmaraiRegular),
                                              const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                  ...
                                  Expanded(
                                    flex: 1,
                                    child: Text(storeList[index].name ?? '', style: AlmaraiMedium),
                                  ),
                                      ...
                                      Positioned(
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                            ...
                                            Text('${distance > 10 ? '10+' : distance.toStringAsFixed(1)} ${'km'.tr}', style: AlmaraiBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeOverSmall)),
                                            const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                                            Text('from_you'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeOverSmall)),
                                          ]),
                                        ),
                                      ),
                                    ]),
...
class BestStoreNearbyShimmer extends StatelessWidget {
  ...
  final bool isFood;
  const BestStoreNearbyShimmer({super.key, required this.isPharmacy, required this.isFood});
