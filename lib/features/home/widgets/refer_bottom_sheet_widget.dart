          ...
          child: SingleChildScrollView(
            child: Padding(
              ...
              child: Column(children: [
                ...
                Text('${'welcome_to'.tr} ${AppConstants.appName}!', style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                ...
                Text(
                  ...
                  textAlign: TextAlign.center, style: AlmaraiRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color?.withValues(alpha: 0.5)),
                ),
