                ...
                Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      Text(item!.name!, maxLines: 1, overflow: TextOverflow.ellipsis, style: AlmaraiBold),
                      ...
                      item!.ratingCount! > 0 ? Row(mainAxisAlignment: isFeatured ? MainAxisAlignment.start : MainAxisAlignment.center, children: [
                        ...
                        Text(item!.avgRating!.toStringAsFixed(1), style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                        const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                        Text("(${item!.ratingCount})", style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                      ]) : const SizedBox(),
                      ...
                      Wrap(crossAxisAlignment: WrapCrossAlignment.center, alignment: WrapAlignment.start, children: [
                        ...
                        Text(
                          ...
                          style: AlmaraiMedium, textDirection: TextDirection.ltr,
                        ),
                      ]),
                        ...
                        children: [
                          Container(
                            ...
                            child: isFood ? Column(
                              ...
                              Text(item!.name!, style: AlmaraiBold, maxLines: 1, overflow: TextOverflow.ellipsis),
                              ...
                              item!.ratingCount! > 0 ? Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                ...
                                const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                Text(item!.avgRating!.toStringAsFixed(1), style: AlmaraiRegular),
                                const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                Text("(${item!.ratingCount})", style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                              ]) : const SizedBox(),
                            ...
                            child: CartCountView(
                              ...
                              child: Center(
                                child: Container(
                                  ...
                                  child: Text("add".tr, style: AlmaraiBold.copyWith(color: Theme.of(context).primaryColor)),
                                ),
                              ),
                            ),
                          ),
