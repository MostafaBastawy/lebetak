                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(store.name ?? '', maxLines: 1, overflow: TextOverflow.ellipsis, style: AlmaraiMedium),
                                    Text(store.address ?? '', maxLines: 1, overflow: TextOverflow.ellipsis, style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor)),
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            Text(store.avgRating!.toStringAsFixed(1), style: AlmaraiRegular),
                                            const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                            Text('(${store.ratingCount})', style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor)),
                                          ],
                                        ),
                                        const SizedBox(width: Dimensions.paddingSizeDefault),
                                        Text('${store.itemCount}' ' ' 'items'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).primaryColor)),
                                      ],
                                    ),
                                  ],
                                ),
