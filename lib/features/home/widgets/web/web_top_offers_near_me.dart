                          ...
                          child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Expanded(
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                ...
                                SizedBox(
                                  width: 150,
                                  child: Text(store.name ?? '', style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeSmall),
                                ...
                                isFood ? RatingBar(
                                  ...
                                  Text('${store.avgRating}', style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
                                  const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                                  Text('(${store.ratingCount})', style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor)),
                                ]),
                                ...
                                Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                                  ...
                                  Text(isAvailable ? 'open_now'.tr : 'closed_now'.tr, style: AlmaraiRegular.copyWith(color: isAvailable ? const Color(0xffECA507) : Theme.of(context).colorScheme.error, fontSize: Dimensions.fontSizeExtraSmall)),
                                ]),
                                ...
                                Row(children: [
                                  ...
                                  Expanded(
                                    child: Text(store.address ?? '',
                                      style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).primaryColor),
                                      maxLines: 1, overflow: TextOverflow.ellipsis,
                                    ),
                                  ),
                                ]),
                            ...
                            child: Row(children: [
                              ...
                              Expanded(
                                child: Row(children: [
                                  ...
                                  Text(
                                    ...
                                    style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).primaryColor),
                                  ),
                                  const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                                  Text('from_you'.tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).primaryColor)),
                                ]),
                              ),
                              ...
                              Container(
                                ...
                                child: Text(
                                  ...
                                  style: AlmaraiMedium.copyWith(color: Theme.of(context).cardColor, fontSize: Dimensions.fontSizeExtraSmall),
                                  textAlign: TextAlign.center,
                                ),
                                // child: Text('new'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).cardColor, fontSize: Dimensions.fontSizeSmall)),
                              ),
                            ]),
                          ),
                        ),
                  ...
                  isFood || isPharmacy ? Positioned(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        discount > 0 ? '${(isRightSide || discountType == 'percent') ? '' : currencySymbol}$discount${discountType == 'percent' ? '%'
                            : isRightSide ? currencySymbol : ''} ${'off'.tr}' : 'free_delivery'.tr,
                        style: AlmaraiMedium.copyWith(color: Theme.of(context).cardColor, fontSize: Dimensions.fontSizeSmall),
                        textAlign: TextAlign.center,
                      ),
                      // child: Text('new'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).cardColor, fontSize: Dimensions.fontSizeSmall)),
                    ),
  ...
  Widget distanceWidget(double distance) {
    return Container(
      ...
      child: Row(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text(
          '${distance > 100 ? '100+' : distance.toStringAsFixed(2)} ${'km'.tr}',
          style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor),
        ),
        const SizedBox(width: Dimensions.paddingSizeExtraSmall),

        Text('from_you'.tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor)),
