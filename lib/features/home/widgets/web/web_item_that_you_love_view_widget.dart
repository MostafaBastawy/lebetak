      ...
      return recommendItems != null ? recommendItems.isNotEmpty ? Stack(children: [
          Column(children: [
            ...
            Padding(
              ...
              child: Text('item_that_you_love'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
            ),
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                                Text(recommendItems[index].name!, style: AlmaraiBold, maxLines: 1, overflow: TextOverflow.ellipsis),

                                                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                  Icon(Icons.star, size: 15, color: Theme.of(context).primaryColor),
                                                  const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                                  Text(recommendItems[index].avgRating!.toStringAsFixed(1), style: AlmaraiRegular),
                                                  const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                                  Text("(${recommendItems[index].ratingCount})", style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                                                ]),
                                  ...
                                  Container(
                                    ...
                                    child: Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                      ...
                                      Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                        Icon(Icons.star, size: 15, color: Theme.of(context).primaryColor),
                                        const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                        Text('0.0', style: AlmaraiRegular),
                                        const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                        Text("(0)", style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                                      ]),
