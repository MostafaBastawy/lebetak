...
class WebBestStoreNearbyViewWidget extends StatefulWidget {
  ...
  @override
  State<WebBestStoreNearbyViewWidget> createState() => _WebBestStoreNearbyViewWidgetState();
}

class _WebBestStoreNearbyViewWidgetState extends State<WebBestStoreNearbyViewWidget> {
                ...
                child: Row(children: [
                  ...
                  InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        'see_all'.tr,
                        style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor, decoration: TextDecoration.underline),
                      ),
                    ),
                  ),
                  ...
                  children: [
                    ...
                    !isPharmacy ? RotatedBox(
                      ...
                      child: Padding(
                        ...
                        child: Text('best_store_nearby'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                      ),
                    ) : const SizedBox(),
                                      ...
                                      child: Stack(children: [
                                        ...
                                        Container(
                                          ...
                                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                ...
                                                Expanded(
                                                  ...
                                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                                    ...
                                                    Row(children: [
                                                      ...
                                                      Text('start_from'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall)),
                                                      const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                                                      Text(PriceConverter.convertPrice(storeList[index].minimumOrder), style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeSmall)),
                                                    ...
                                                    Row(children: [
                                                      ...
                                                      Text(storeList[index].avgRating!.toStringAsFixed(1), style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                                                      const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                                                      Text("(${storeList[index].ratingCount.toString()})", style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                                                    ...
                                                    Container(
                                                      ...
                                                      child: Row(children: [
                                                        ...
                                                        Text('${distance > 10 ? '10+' : distance.toStringAsFixed(1)} ${'km'.tr}', style: AlmaraiBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeExtraSmall)),
                                                        const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                                                        Text('from_you'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeExtraSmall)),
                                                      ]),
                                                    ),
                                            ...
                                            Expanded(
                                              flex: 2,
                                              child: Text(storeList[index].name!, style: AlmaraiMedium, maxLines: 1, overflow: TextOverflow.ellipsis),
                                            ),
                                          ]),
                                        ),
...
class WebBestStoreNearbyShimmerView extends StatelessWidget {
  ...
  const WebBestStoreNearbyShimmerView({super.key, required this.storeController});
