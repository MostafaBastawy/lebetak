      ...
      return flashSaleController.flashSaleModel != null ? flashSaleController.flashSaleModel!.activeProducts != null ? Container(
        ...
        child: Column(children: [
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              InkWell(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('flash_sale'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
          ...
          Padding(
            ...
            child: Text("${item!.name}", style: AlmaraiRegular, maxLines: 1, overflow: TextOverflow.ellipsis,),
          ),
          const SizedBox(height: Dimensions.paddingSizeExtraSmall),
