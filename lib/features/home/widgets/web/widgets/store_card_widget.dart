            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: /*Theme.of(context).disabledColor.withValues(alpha: 0.1)*/Colors.transparent),
                    ...
                    Stack(clipBehavior: Clip.none, children: [
                      ClipRRect(
                        borderRadius: const BorderRadius.vertical(
                            top: Radius.circular(Dimensions.radiusDefault+15),
                            bottom: Radius.circular(Dimensions.radiusDefault+15)
                        ),
                        child: CustomImage(
                          isHovered: hovered,
                      ...
                      isAvailable ? const SizedBox() : NotAvailableWidget(isStore: true, store: store, fontSize: Dimensions.fontSizeExtraSmall, /*isAllSideRound: false,*/radius: Dimensions.radiusDefault+15,),
                      Positioned(
                        top: Dimensions.paddingSizeSmall+5, right: Dimensions.paddingSizeSmall+300,
                        child: GetBuilder<FavouriteController>(builder: (favouriteController) {
                          ...
                          return InkWell(
                            ...
                            child: Icon(
                              isWished ? Icons.favorite : Icons.favorite_border,  size: 26,
