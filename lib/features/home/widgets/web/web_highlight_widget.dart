              ...
              Padding(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text('highlights_for_you'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Get.isDarkMode ? Colors.white : Colors.black)),
                      const SizedBox(width: 5),

                      Text('see_our_most_popular_store_and_item'.tr, style: AlmaraiRegular.copyWith(color: Get.isDarkMode ? Colors.white70 : Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall)),
                    ],
                  ),
