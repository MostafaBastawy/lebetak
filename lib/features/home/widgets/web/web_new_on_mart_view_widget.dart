                                        ...
                                        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                          ...
                                          Expanded(
                                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                              ...
                                              SizedBox(
                                                width: 150,
                                                child: Text(storeList[index].name ?? '', style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeSmall),
                                              ...
                                              Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                                                ...
                                                Text(storeController.isOpenNow(storeList[index]) ? 'open_now'.tr : 'closed_now'.tr, style: AlmaraiRegular.copyWith(color: storeController.isOpenNow(storeList[index]) ? const Color(0xffECA507) : Theme.of(context).colorScheme.error, fontSize: Dimensions.fontSizeSmall)),
                                              ]),
                                      ...
                                      child: Row(children: [
                                        ...
                                        Container(
                                          ...
                                          child: Row(children: [
                                            ...
                                            Text('from_you'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).primaryColor)),
                                          ]),
                                        ),
                                      ]),
                                    ),
