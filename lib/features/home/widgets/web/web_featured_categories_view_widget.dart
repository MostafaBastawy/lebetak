...
class WebFeaturedCategoriesViewWidget extends StatefulWidget {
  ...
  @override
  State<WebFeaturedCategoriesViewWidget> createState() => _WebFeaturedCategoriesViewWidgetState();
}

class _WebFeaturedCategoriesViewWidgetState extends State<WebFeaturedCategoriesViewWidget> {
            ...
            child: Container(
              ...
              child: Column(children: [
                Padding(
                  ...
                  child: Column(children: [
                    Text('featured_categories'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                          ...
                          return Column(children: [
                            InkWell(
                              ...
                              child: Padding(
                                ...
                                child: Text('${categoryList[index].name}', style: AlmaraiMedium.copyWith(color: isSelected ? Theme.of(context).primaryColor : Theme.of(context).disabledColor)),
                              ),
                            ),
