                              ...
                              child: Column(children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    ...
                                    style: AlmaraiMedium.copyWith(fontSize: 11),
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Column(children: [
                    ...
                    Expanded(child: Text(
                      categoryController.categoryList![index].name!,
                      style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyMedium!.color),
