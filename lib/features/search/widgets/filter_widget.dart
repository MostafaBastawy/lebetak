          ...
          return SingleChildScrollView(
            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Text('filter'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                CustomButton(
                  onPressed: () {
                    if(isStore) {
              ...
              Text('sort_by'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
              ...
              Text('filter_by'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
              const SizedBox(height: Dimensions.paddingSizeSmall),
              ...
              isStore ? const SizedBox() : Column(children: [
                Text('price'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                RangeSlider(
              ...
              Text('rating'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
