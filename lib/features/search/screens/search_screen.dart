                ...
                child: SizedBox(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('search_items_and_stores'.tr, style: AlmaraiMedium),
                      const SizedBox(height: Dimensions.paddingSizeDefault),
                  ...
                  child: SizedBox(width: Dimensions.webMaxWidth, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    searchController.historyList.isNotEmpty ? Padding(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        Text(ResponsiveHelper.isDesktop(context) ? 'recent_searches'.tr : 'your_last_search'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                        InkWell(
                          ...
                          child: Padding(
                            ...
                            child: Text('clear_all'.tr, style: AlmaraiRegular.copyWith(
                            ...
                            margin: const EdgeInsets.only(right: Dimensions.paddingSizeSmall),
                             padding: const EdgeInsets.symmetric(horizontal : Dimensions.paddingSizeDefault),
                              ...
                              child: InkWell(
                                ...
                                child: Row(
                                  children: [
                                    Text(searchController.historyList[index], style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).primaryColor), maxLines: 1, overflow: TextOverflow.ellipsis),
                                    const SizedBox(width: Dimensions.paddingSizeSmall),
                              ...
                              Expanded(
                                child: Padding(
                                  ...
                                  child: Text(
                                    ...
                                    style: AlmaraiRegular, maxLines: 1, overflow: TextOverflow.ellipsis,
                                  ),
                                ),
                              ),
                              InkWell(
                    ...
                    (_isLoggedIn && searchController.suggestedItemList != null) ? Text(
                      'suggestions'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                    ) : const SizedBox(),
                    ...
                    (searchController.popularCategoryList != null && searchController.popularCategoryList!.isNotEmpty) ? Text(
                      'popular_categories'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                    ) : const SizedBox(),
                    const SizedBox(height: Dimensions.paddingSizeSmall),
                        ...
                        return Padding(
                          ...
                          child: CustomInkWell(
                            ...
                            child: Container(
                              ...
                              child: Text(
                                category!.name??'',
                                style: AlmaraiRegular.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color!),
        ...
        child: SizedBox(
          ...
          child: foodsAndRestaurants.isNotEmpty ? ListView.builder(
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Text('no_suggestions_found'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).hintColor)),
            ]),
          ),
        ),
      ),
