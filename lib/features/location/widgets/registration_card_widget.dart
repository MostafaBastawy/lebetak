          ...
          Expanded(flex: 6, child: Padding(
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              Text(
                ...
                style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge), textAlign: TextAlign.center,
              ),
              const SizedBox(height: Dimensions.paddingSizeLarge),
              Text(
                isStore ? splashController.landingModel!.joinSellerSubTitle ?? '' : splashController.landingModel!.joinDeliveryManSubTitle ?? '',
                style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall), textAlign: TextAlign.center,
              ),
