        ...
        builder: (splashController) {
          return splashController.landingModel == null ? const WebLandingPageShimmerWidget() : Column(children: [
            ...
            Container(
              ...
              child: Row(children: [
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text(splashController.landingModel?.fixedHeaderTitle ?? '', style: AlmaraiBold.copyWith(fontSize: 35)),
                  const SizedBox(height: Dimensions.paddingSizeLarge),

                  Text(
                    splashController.landingModel?.fixedHeaderSubTitle ?? '',
                    style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).primaryColor),
                  ),
                ])),
            ...
            Text(
              ...
              style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).primaryColor),
            ),
            Text(
              splashController.landingModel?.fixedModuleSubTitle ?? '',
              style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).disabledColor),
            ),
            const SizedBox(height: 40),
                      ...
                      child: Row(children: [
                        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Text(
                            ...
                            style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeDefault), textAlign: TextAlign.center,
                          ),
                          ...
                          Expanded(child: SingleChildScrollView(
                            ...
                            child: HtmlWidget(
                              ...
                              textStyle: AlmaraiRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.6)),
                              onTapUrl: (String url){
                              ...
                              child: MouseRegion(
                                ...
                                child: CustomToolTip(
                                  content: SizedBox(
                                    ...
                                    child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      Text(
                                        ...
                                        style: AlmaraiBold.copyWith(color: Theme.of(context).cardColor),
                                      ),
                                      const SizedBox(height: Dimensions.paddingSizeSmall),

                                      Text(
                                        modulesText.isEmpty ? 'no_modules_are_available'.tr : '$modulesText ${'modules_are_available'.tr}',
                                        style: AlmaraiRegular.copyWith(color: Theme.of(context).cardColor, fontSize: Dimensions.fontSizeSmall),
                                      ),
                                    ]),
                                  ),
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(
                                      splashController.landingModel?.availableZoneList?[index].displayName ?? '',
                                      style: AlmaraiBold.copyWith(color: splashController.hoverStates[index] ? Theme.of(context).primaryColor :  Theme.of(context).textTheme.bodyMedium!.color!),
            ...
            ? Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
              ...
              Column(children: [
                Text(
                  ...
                  style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge),
                ),
                const SizedBox(height: Dimensions.paddingSizeSmall),

                Text(
                  splashController.landingModel!.downloadUserAppSubTitle ?? '', textAlign: TextAlign.center,
                  style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall),
                ),
                const SizedBox(height: Dimensions.paddingSizeLarge),
