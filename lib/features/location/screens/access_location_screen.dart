          ...
          child: Padding(
            ...
            child: GetBuilder<AddressController>(
              builder: (locationController) {
                ...
                return (ResponsiveHelper.isDesktop(context) && AddressHelper.getUserAddressFromSharedPref() == null)
                    ? WebLandingPage(fromSignUp: widget.fromSignUp, fromHome: widget.fromHome, route: widget.route)
                    : isLoggedIn
                        ? Column(
                            children: [
                              Expanded(
                                  ...
                                  child: FooterView(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        ResponsiveHelper.isDesktop(context)
                                            ? BottomButton(fromSignUp: widget.fromSignUp, route: widget.route)
                                            : const SizedBox(),
                                      ],
                                    ),
                                  ),
