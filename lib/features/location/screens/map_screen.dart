                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: widget.fromStore ? Row(children: [
                            Expanded(
                              child: Text(widget.address.address ?? '', style: AlmaraiMedium, maxLines: 2, overflow: TextOverflow.ellipsis),
                            ),
                            ...
                            children: [
                              ...
                              Row(children: [
                                ...
                                Expanded(
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                                    ...
                                    Text(widget.address.addressType!.tr, style: AlmaraiRegular.copyWith(
                              ...
                              Text('- ${widget.address.contactPersonName}', style: AlmaraiMedium.copyWith(
                                color: Theme.of(context).primaryColor,
                                fontSize: Dimensions.fontSizeLarge,
                              )),

                              Text('- ${widget.address.contactPersonNumber}', style: AlmaraiRegular),
