            ...
            child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              if(message.message != null) Flexible(
                child: Container(
                  ...
                  child: Text(message.message ?? '', style: AlmaraiRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color, fontSize: Dimensions.fontSizeSmall)),
                ),
              ),
      ...
      child: Column(children: [
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(children: [
                  Text('${'order_id'.tr} ', style: AlmaraiMedium),
                  Text('#${order.id}', style: AlmaraiBold),
                ]),

                Text('${'total'.tr}: ${PriceConverter.convertPrice(order.orderAmount ?? 0)}', style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor)),
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.end, children: [
                Container(
                  ...
                  child: Text(
                    ...
                    style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Colors.deepPurple),
                  ),
                ),

                Text(DateConverter.stringToLocalDateOnly(order.createdAt!), style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
              ]),
            ),
        ...
        Container(
          ...
          child: Row(children: [
            ...
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('delivery_address'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall)),
                const SizedBox(height: Dimensions.paddingSizeExtraSmall),

                Text(order.deliveryAddress?.contactPersonNumber??'', style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),

                RichText(
                  textAlign: TextAlign.start, maxLines: 2, overflow: TextOverflow.ellipsis,
                  text: TextSpan(
                    style: AlmaraiRegular.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color, fontSize: Dimensions.fontSizeSmall,),
                    children: [
            ...
            order.detailsCount != null && order.detailsCount! > 0 ? Container(
              ...
              padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
              child: Column(children: [
                Text('items'.tr, style: AlmaraiRegular),
                Text(order.detailsCount.toString(), style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeOverLarge)),
              ]),
            ) : const SizedBox(),
