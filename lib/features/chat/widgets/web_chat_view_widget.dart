    ...
    return Column(
      children: [
        Container(
          ...
          child: Center(child: Text('live_chat'.tr, style: AlmaraiMedium)),
        ),
                  ...
                  child: MouseRegion(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeLarge, vertical: Dimensions.paddingSizeSmall),
                          child: Text('messages'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                        ),
                                        ...
                                        Padding(
                                          ...
                                          child: Row(children: [
                                            ...
                                            Expanded(child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                              ...
                                              Text(
                                                '${Get.find<SplashController>().configModel!.businessName}', style: AlmaraiMedium,
                                              ),
                            ...
                            Padding(
                              ...
                              child: Align(
                                ...
                                child: TabBar(
                                  ...
                                  labelStyle: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeDefault),
                                  unselectedLabelStyle: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeDefault),
                              ...
                              Expanded(child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Flexible(
                                      child: Text(
                                        widget.chatController.notificationBody!.name!, style: AlmaraiMedium, maxLines: 1, overflow: TextOverflow.ellipsis,
                                      ),
                                    ),

                                    // Text('(${widget.chatController.notificationBody!.receiverType!.tr})', style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor)),
                                  ],
                                ),
                                const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                                  ...
                                  children: [
                                    ...
                                    TextField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintStyle: AlmaraiRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall),
                                      ),
