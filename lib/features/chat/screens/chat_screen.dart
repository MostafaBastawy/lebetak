        ...
        child: Scaffold(
          ...
          appBar: (ResponsiveHelper.isDesktop(context) ? const WebMenuBar() : AppBar(
            ...
            title: Text(
              ...
              style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge, fontWeight: FontWeight.w600, color: Theme.of(context).textTheme.bodyLarge!.color),
            ),
                                      ...
                                      Expanded(
                                        child: TextField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            hintStyle: AlmaraiRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeLarge),
                                          ),
                    ...
                    children: [
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        Padding(
                          ...
                          child: Text('choose_the_reason_for_support'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                        ),
                                ...
                                child: TextHover(
                                  builder: (isHovered) {
                                    return Container(
                                      ...
                                      child: Text(orderController.supportReasons![index]??'', style: isHovered ? AlmaraiMedium : AlmaraiRegular),
                                    );
                                  }
                                ),
                              );
