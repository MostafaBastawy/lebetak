          ...
          label: SizedBox(
            ...
            child: Text(
              '${'chat_with'.tr} ${Get.find<SplashController>().configModel!.businessName}',
                ...
                style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Colors.white),
            ),
          ),
                            ...
                            child: Stack(children: [
                              Padding(
                                ...
                                child: Row(children: [
                                  ...
                                  Expanded(child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    ...
                                    user != null ? Text(
                                      '${user.fName} ${user.lName}', style: AlmaraiMedium,
                                    ) : Text('${type!.tr} ${'deleted'.tr}', style: AlmaraiMedium),
                              ...
                              Positioned(
                                ...
                                child: Text(
                                  ...
                                  style: AlmaraiRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeExtraSmall),
                                ),
                              ),
