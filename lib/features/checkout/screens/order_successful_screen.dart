            ...
            child: SingleChildScrollView(
              child: FooterView(child: SizedBox(width: Dimensions.webMaxWidth, child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Text('sign_in'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor)),
                      ),
                    ),
                  ]),
                ) : const SizedBox(),
                ...
                AuthHelper.isGuestLoggedIn() ? SelectableText(
                  '${'order_id'.tr}: $orderId',
                  style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).primaryColor),
                ) : const SizedBox(),
                ...
                ResponsiveHelper.isDesktop(context) && (success && Get.find<SplashController>().configModel!.loyaltyPointStatus == 1 && total.floor() > 0 ) && AuthHelper.isLoggedIn()  ? Column(children: [
                  ...
                  Text('congratulations'.tr , style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                  const SizedBox(height: Dimensions.paddingSizeSmall),
