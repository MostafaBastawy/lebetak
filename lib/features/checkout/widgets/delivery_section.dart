      ...
      isGuestLoggedIn ? GuestDeliveryAddress(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Text('deliver_to'.tr, style: AlmaraiMedium),
            TextButton.icon(
              onPressed: () async {
              ...
              label: Text('add_new'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
            ),
          ]),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(address[index].addressType!.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
