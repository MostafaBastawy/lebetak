          ...
          child: Row(children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text( title, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color )),
                  const SizedBox(height : Dimensions.paddingSizeExtraSmall),
                  Text( subTitle, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor)),
                ],
              ),
            ),
