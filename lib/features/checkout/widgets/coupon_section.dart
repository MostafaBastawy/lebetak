        ...
        return Container(
          ...
          child: Column(children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text('promo_code'.tr, style: AlmaraiMedium),
              InkWell(
                onTap: () {
                ...
                child: Padding(
                  ...
                  child: Row(children: [
                    Text('add_voucher'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor)),
                ...
                Expanded(
                  child: SizedBox(
                    ...
                    child: TextField(
                      ...
                      style: AlmaraiRegular.copyWith(height: ResponsiveHelper.isMobile(context) ? null : 2),
                      decoration: InputDecoration(
                        hintText: 'enter_promo_code'.tr,
                        hintStyle: AlmaraiRegular.copyWith(color: Theme.of(context).hintColor),
                        isDense: true,
                        filled: true,
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: (couponController.discount! <= 0 && !couponController.freeDelivery) ? !couponController.isLoading ? Text(
                      'apply'.tr,
                      style: AlmaraiMedium.copyWith(color: Theme.of(context).cardColor),
                    ) : const SizedBox(
                      height: 30, width: 30,
