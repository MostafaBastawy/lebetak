...
class GuestDeliveryAddress extends StatelessWidget {
    ...
    return Container(
      ...
      child: Column(children: [
        Row(children: [
          ...
          Text(takeAway ? 'contact_information'.tr : 'delivery_information'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).primaryColor)),
          const Spacer(),
        ...
        takeAway ? Column(children: [
          ...
          child: Padding(
            ...
            child: Column(children: [
              ...
              Text('please_update_your_delivery_info'.tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).disabledColor)),
            ]),
          ),
        ) : Column(children: [
  ...
  Widget addressInfo(String key, String value) {
    return Padding(
      ...
      child: Row(children: [
        Text('$key: ', style: AlmaraiRegular.copyWith(color: Theme.of(Get.context!).disabledColor)),
        Flexible(child: Text(value, style: AlmaraiRegular, maxLines: 1, overflow: TextOverflow.ellipsis)),
      ]),
    );
  }
}
