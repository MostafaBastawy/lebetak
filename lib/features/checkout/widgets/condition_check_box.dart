    ...
    return Row(children: [
      ...
      Expanded(
        child: RichText(text: TextSpan(children: [
          ...
          TextSpan(
            text: 'privacy_policy'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor),
          ...
          TextSpan(
            text: 'terms_conditions'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor),
            recognizer: TapGestureRecognizer()
              ..onTap = () => Get.toNamed(RouteHelper.getHtmlRoute('terms-and-condition')),
          ),
          !isParcel && activeRefund ? TextSpan(text: ' ${'and'.tr} ', style: AlmaraiRegular.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color)) : const TextSpan(),

          !isParcel && activeRefund ? TextSpan(
            text: 'refund_policy'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor),
            recognizer: TapGestureRecognizer()
