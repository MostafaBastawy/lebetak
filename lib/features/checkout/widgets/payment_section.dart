  ...
  Widget build(BuildContext context) {
    return Column(children: [
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Text(storeId != null ? 'payment_method'.tr : 'choose_payment_method'.tr, style: AlmaraiMedium),
        ...
        child: storeId != null ? checkoutController.paymentMethodIndex == 0 ? Row(children: [
          ...
          child: Row(children: [
            ...
            checkoutController.paymentMethodIndex != -1 ? PriceConverter.convertAnimationPrice(
              ...
              textStyle: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).primaryColor),
            ) : const SizedBox(),
            // Text(
            //   PriceConverter.convertPrice(total), textDirection: TextDirection.ltr,
            //   style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).primaryColor),
