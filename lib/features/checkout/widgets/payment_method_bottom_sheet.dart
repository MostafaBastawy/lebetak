                  ...
                  builder: (checkoutController) {
                    return Column(
                      ...
                      children: [
                        ...
                        Align(alignment: Alignment.center, child: Text('payment_method'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge))),
                        const SizedBox(height: Dimensions.paddingSizeLarge),
                        ...
                        ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text('choose_payment_method'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
