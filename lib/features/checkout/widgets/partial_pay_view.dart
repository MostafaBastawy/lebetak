...
class PartialPayView extends StatelessWidget {
  ...
  const PartialPayView({super.key, required this.totalPrice, required this.isPrescription});
          ...
          child: ResponsiveHelper.isDesktop(context) ?  Row(children: [
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                checkoutController.isPartialPay || checkoutController.paymentMethodIndex == 1 ? Row(children: [
                  ...
                  Text(
                    'applied'.tr,
                    style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeDefault),
                  )
                ]) : Text(
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Text(
                  ...
                  style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeDefault, color: checkoutController.isPartialPay || checkoutController.paymentMethodIndex == 1 ? Colors.red : Colors.white),
                ),
              ),
            ),
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(
                  PriceConverter.convertPrice(Get.find<ProfileController>().userInfoModel!.walletBalance!),
                  style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeOverLarge, color: Theme.of(context).primaryColor),
                ),
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Text(
                    checkoutController.isPartialPay || checkoutController.paymentMethodIndex == 1 ? 'remove'.tr : 'use'.tr,
                    style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: checkoutController.isPartialPay || checkoutController.paymentMethodIndex == 1 ? Colors.red : Colors.white),
                  ),
                ),
              ),
