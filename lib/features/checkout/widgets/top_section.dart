      ...
      child: Column(children: [
        ...
        storeId != null ? Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              Text('your_prescription'.tr, style: AlmaraiMedium),
              ...
              JustTheTooltip(
                ...
                content: Padding(
                  ...
                  child: Text('prescription_tool_tip'.tr, style: AlmaraiRegular.copyWith(color: Colors.white)),
                ),
                child: InkWell(
                      ...
                      child: DottedBorder(
                        ...
                        child: Container(
                          ...
                          child:  Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            Text('upload_your_prescription'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall), textAlign: TextAlign.center,),
                          ]),
                        ),
                      ),
                    );
        ...
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('delivery_type'.tr, style: AlmaraiMedium),
              const SizedBox(height: Dimensions.paddingSizeSmall),
