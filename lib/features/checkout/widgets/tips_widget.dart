    ...
    return Padding(
      ...
      child: Column(children: [
          ...
          child: Container(
            ...
            child: Column(children: [
              ...
              isSuggested && ResponsiveHelper.isDesktop(context) ? Container(
                ...
                child: Text(
                  'most_tipped'.tr, style: AlmaraiRegular.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeOverSmall),
                ),
        ...
        isSuggested && !ResponsiveHelper.isDesktop(context) ? Text(
          'most_tipped'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeExtraSmall),
        ) : const SizedBox(),
      ]),
    );
  }
