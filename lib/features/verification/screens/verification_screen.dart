          ...
          child: GetBuilder<VerificationController>(builder: (verificationController) {
            return Column(children: [
              ...
              isDesktop ? Padding(
                ...
                child: Text(
                  'otp_verification'.tr, style: AlmaraiRegular,
                ),
              ) : const SizedBox(),
              ...
              Get.find<SplashController>().configModel!.demo! ? Text(
                'for_demo_purpose'.tr, style: AlmaraiMedium,
              ) : SizedBox(
                width: 250,
                child: Wrap(crossAxisAlignment: WrapCrossAlignment.center, children: [
                  RichText(text: TextSpan(children: [
                    TextSpan(text: 'we_have_a_verification_code'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).hintColor)),
                    TextSpan(text: ' ${(_email != null && _email!.isNotEmpty) ? _email : _number}', style: AlmaraiMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color)),
              ...
              Padding(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  Text(
                    ...
                    style: AlmaraiRegular.copyWith(color: Theme.of(context).hintColor),
                  ),
                  TextButton(
