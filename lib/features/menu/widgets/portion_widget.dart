      ...
      child: Container(
        ...
        child: Column(children: [
          Row(children: [
            ...
            Expanded(child: Text(title, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeDefault))),
            ...
            suffix != null ? Container(
              ...
              child: Text(suffix!, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.white), textDirection: TextDirection.ltr),
            ) : const SizedBox(),
          ]),
