                ...
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    isLoggedIn && profileController.userInfoModel == null ? Shimmer(
                      ...
                      style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: Theme.of(context).cardColor),
                    ),
                    ...
                    isLoggedIn && profileController.userInfoModel == null ? Shimmer(
                      ...
                      style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).cardColor),
                    ) : InkWell(
                      onTap: () async {
              ...
              child: Column(children: [
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Padding(
                    ...
                    child: Text(
                      'general'.tr,
                      style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).primaryColor.withValues(alpha: 0.5)),
                    ),
                  ),
                ...
                InkWell(
                  ...
                  child: Padding(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      Text(AuthHelper.isLoggedIn() ? 'logout'.tr : 'sign_in'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge))
                    ]),
                  ),
                ),
