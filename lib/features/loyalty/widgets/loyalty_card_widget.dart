      ...
      builder: (profileController) {
        return Column(
          ...
          children: [
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  ResponsiveHelper.isDesktop(context) ? const SizedBox() : Text(
                    ...
                    style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color),
                  ),

                  Text(
                    profileController.userInfoModel!.loyaltyPoint == null ? '0' : profileController.userInfoModel!.loyaltyPoint.toString(),
                    style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeOverLarge, color: Theme.of(context).textTheme.bodyLarge!.color),
                  ),
            ...
            ResponsiveHelper.isDesktop(context) ? Text('how_to_use'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)) : const SizedBox(),
            ResponsiveHelper.isDesktop(context) ? const SizedBox(height: Dimensions.paddingSizeDefault) : const SizedBox(),
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text('convert_your_loyalty_point_to_wallet_money'.tr, style: AlmaraiRegular),
                    Text('${'minimun'.tr} ${Get.find<SplashController>().configModel!.loyaltyPointExchangeRate} ${'points_required_to_convert_into_currency'.tr}', style: AlmaraiRegular),
                  ],
                ),
              ),
