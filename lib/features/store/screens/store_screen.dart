                                ...
                                child: Container(
                                  ...
                                  child: Row(children: [
                                        ...
                                        storeController.isStoreOpenNow(store.active!, store.schedules) ? const SizedBox() : Positioned(
                                          ...
                                          child: Container(
                                            ...
                                            child: Text(
                                              ...
                                              style: AlmaraiRegular.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeSmall),
                                            ),
                                          ),
                                        ),
                                      ]),
                                    ...
                                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.center, children: [
                                      Row(children: [
                                        Expanded(child: Text(
                                          store.name!, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge - (scrollingRate * 3), color: Theme.of(context).textTheme.bodyMedium!.color),
                                      ...
                                      Text(
                                        ...
                                        style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall - (scrollingRate * 2), color: Theme.of(context).disabledColor),
                                      ),
                                      SizedBox(height: ResponsiveHelper.isDesktop(context) ? Dimensions.paddingSizeExtraSmall : 0),
                                      Row(children: [
                                        Flexible(
                                          child: Text('minimum_order'.tr, style: AlmaraiRegular.copyWith(
                                        ...
                                        Text(
                                          ...
                                          style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall - (scrollingRate * 2), color: Theme.of(context).primaryColor),
                                        ),
                                      ]),
                                    ])),
                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('recommended_for_you'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge, fontWeight: FontWeight.w700)),
                          const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                          Text('here_is_what_you_might_like'.tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                          const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                                            ...
                                            child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                              Text(
                                                ...
                                                style: index == storeController.categoryIndex
                                                    ? AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor)
                                                    : AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
                                              ),
                                            ]),
                                          ),
                                        ),
                                        ...
                                        Expanded(
                                          child: TextField(
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              hintStyle: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor),
                ...
                child: Column(children: [
                  ...
                  store?.announcementActive??false ? Container(
                    ...
                    child: Row(children: [
                      ...
                      Flexible(child: Text(store?.announcementMessage??'', style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall))),
                    ]),
                  ) : const SizedBox(),
                  ...
                  (!ResponsiveHelper.isDesktop(context) && storeController.recommendedItemModel != null && storeController.recommendedItemModel!.items!.isNotEmpty) ? Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('recommended_for_you'.tr, style: AlmaraiMedium),
                      const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                  ...
                  child: Column(
                    children: [
                      Padding(
                        padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                        child: Row(children: [
                          Text('all_products'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
