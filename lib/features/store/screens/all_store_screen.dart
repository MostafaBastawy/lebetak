                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        SizedBox(
                          ...
                          child: Row(children: [
                            ...
                            Text('top_offers_near_me'.tr, style: AlmaraiMedium),
                            const Spacer(),
                            ...
                            PopupMenuButton(
                              ...
                              itemBuilder: (context) {
                                return [
                                  PopupMenuItem(
                                    value: 'asc',
                                    child: Text('sort_by_a_to_z'.tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color)),
                                  ),
                                  PopupMenuItem(
                                    value: 'desc',
                                    child: Text('sort_by_z_to_a'.tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color)),
                                  ),
                                ];
                              },
                            ...
                            isFood ? PopupMenuButton(
                              ...
                              itemBuilder: (context) {
                                return [
                                  PopupMenuItem(
                                    value: '1',
                                    child: Text('only_halal'.tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color)),
                                  ),
                                  PopupMenuItem(
                                    value: 'veg',
                                    child: Text('only_veg'.tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color)),
                                  ),
                                  PopupMenuItem(
                                    value: 'non_veg',
                                    child: Text('only_non_veg'.tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color)),
                                  ),
                                ];
                              },
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(Dimensions.radiusSmall)),
