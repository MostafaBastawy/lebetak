          ...
          slivers: [
            ...
            ResponsiveHelper.isDesktop(context) ? SliverToBoxAdapter(
                        ...
                        child: campaignController.basicCampaign != null ? Column(
                          ...
                          children: [
                            Text(
                              ...
                              style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeOverLarge, color: Colors.white),
                            ...
                            Text(
                              ...
                              style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).disabledColor),
                            ),
                            ...
                            campaignController.basicCampaign!.startTime != null ? Row(children: [
                              ...
                              Text('${'campaign_schedule'.tr}:', style: AlmaraiRegular.copyWith(
                            ...
                            campaignController.basicCampaign!.startTime != null ? Row(children: [
                              ...
                              Text('${'daily_time'.tr}:', style: AlmaraiRegular.copyWith(
                                fontSize: Dimensions.fontSizeExtraSmall, color: Colors.white,
                              )),
                              const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                              Text(
              ...
              flexibleSpace: FlexibleSpaceBar(
                ...
                //   style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Colors.black),
                // ),
              ...
              child: Column(children: [
                ...
                campaignController.basicCampaign != null && !ResponsiveHelper.isDesktop(context) ? Column(
                  children: [
                    ...
                    Row(children: [
                      ...
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text(
                          campaignController.basicCampaign!.title!, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                          maxLines: 1, overflow: TextOverflow.ellipsis,
                        ),
                        Text(
                          campaignController.basicCampaign!.description ?? '', maxLines: 2, overflow: TextOverflow.ellipsis,
                  ...
                  child: Padding(
                    ...
                    child: Text('store_list'.tr, style: AlmaraiBold.copyWith(
