    ...
    return Column(children: [
      ResponsiveHelper.isDesktop(context) ? Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            Expanded(child: Text(
              store!.name!, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: textColor),
                  ...
                  child: Center(
                    child: Row(
                      children: [
                        ...
                        Text('wish_list'.tr, style: AlmaraiRegular.copyWith(fontWeight: FontWeight.w200, color: Colors.white, fontSize: Dimensions.fontSizeSmall)),
                      ],
                    ),
                  ),
                ) : Icon(
          ...
          Row(children: [
            Text('minimum_order_amount'.tr, style: AlmaraiRegular.copyWith(
       ...
       child: Row(children: [
           ...
           child: Column(children: [
             Row(children: [
               ...
               Text(
                 ...
                 style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: textColor),
               ),
             ]),
             const SizedBox(height: Dimensions.paddingSizeExtraSmall),
             Text(
               '${store!.ratingCount} + ${'ratings'.tr}',
               style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: textColor),
             ),
           ]),
         ),
         const Expanded(child: SizedBox()),
         ...
         InkWell(
           ...
           child: Column(children: [
             ...
             const SizedBox(height: Dimensions.paddingSizeExtraSmall),
             Text('location'.tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: textColor)),
           ]),
         ),
         const Expanded(child: SizedBox()),
         const VerticalDivider(color: Colors.white, thickness: 1),
         ...
         Column(children: [
           ...
           Text(store!.deliveryTime!, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: textColor)),
         ]),
         ...
         (store!.delivery! && store!.freeDelivery!) ? Column(children: [
           ...
           const SizedBox(width: Dimensions.paddingSizeExtraSmall),
           Text('free_delivery'.tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: textColor)),
         ]) : const SizedBox(),
         const Expanded(child: SizedBox()),
       ]),
     ):
     Row(children: [
       ...
       Column(children: [
         ...
         const SizedBox(width: Dimensions.paddingSizeExtraSmall),
         Text('delivery_time'.tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: textColor)),
       ]),
       (store!.delivery! && store!.freeDelivery!) ? const Expanded(child: SizedBox()) : const SizedBox(),
       (store!.delivery! && store!.freeDelivery!) ? Column(children: [
         Icon(Icons.money_off, color: Theme.of(context).primaryColor, size: 20),
