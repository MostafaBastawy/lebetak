                ...
                Row(
                  children: [
                    ...
                    Expanded(child: Column(
                      ...
                      children: [
                        Text(widget.orderDetailsList[index].itemDetails!.name!, style: AlmaraiMedium, maxLines: 2, overflow: TextOverflow.ellipsis),
                        const SizedBox(height: 10),
                        Text(PriceConverter.convertPrice(widget.orderDetailsList[index].itemDetails!.price), style: AlmaraiBold, textDirection: TextDirection.ltr),
                      ],
                    )),
                    Row(children: [
                      Text(
                        '${'quantity'.tr}: ',
                        style: AlmaraiMedium.copyWith(color: Theme.of(context).disabledColor), overflow: TextOverflow.ellipsis,
                      ),
                      Text(
