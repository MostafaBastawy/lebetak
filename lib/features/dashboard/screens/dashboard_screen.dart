                                ...
                                child: Stack(children: [
                                 ...
                                 /* Center(
                                  ...
                                  : (orderController.showBottomSheet && orderController.runningOrderModel != null && orderController.runningOrderModel!.orders!.isNotEmpty && _isLogin) ? const SizedBox() : Center(
                                    child:SizedBox(
                                      width: size.width,
                                      height: 60, // تم تقليل الارتفاع من 80 إلى 60
                                      child: Row(
                                        ...
                                        children: [
                                          BottomNavItemWidget(
                                            ...
                                            unSelectedIcon: Images.homeSelect,
                                            isSelected: _pageIndex == 0,
                                            onTap: () => _setPage(0),
                                            iconSize: 24, // ← حجم الصورة (أضف هذا في widget)
                                            fontSize: 12, // ← حجم الخط (أضف هذا في widget)
                                          ),
                                          SizedBox(width: 45,),
                                          BottomNavItemWidget(
                                            ...
                                            unSelectedIcon: isParcel ? Images.addressUnselect : Images.favouriteSelect,
                                          ...
                                          SizedBox(width: 45,),
                                          BottomNavItemWidget(
                                            title: isTaxi ? 'trips'.tr : 'orders'.tr,
                                            selectedIcon: Images.orderSelect,
                                            unSelectedIcon: Images.orderSelect,
