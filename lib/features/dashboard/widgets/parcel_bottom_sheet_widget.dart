                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text('select_and_deliver'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                        const SizedBox(height: Dimensions.paddingSizeExtraSmall),

                        Text('what_are_you_wish_to_send'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor)),
                      ]),
                    ),
                  ),
                  const SizedBox(height: Dimensions.paddingSizeLarge),
