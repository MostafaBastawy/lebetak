            ...
            Flexible(
              child: SingleChildScrollView(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Text('${'hey_welcome_back'.tr}\n${'which_location_do_you_want_to_select'.tr}', style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                  ...
                  Align(
                    ...
                    child: TextButton.icon(
                      ...
                      label: Text('use_current_location'.tr, style: fromDialog ? AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: addressController.addressList != null && addressController.addressList!.isEmpty
                          ? Theme.of(context).cardColor : Theme.of(context).primaryColor) : AlmaraiMedium.copyWith(color: addressController.addressList != null && addressController.addressList!.isEmpty
                          ? Theme.of(context).cardColor : Theme.of(context).primaryColor)),
                    ),
                  ),
                  ...
                  addressController.addressList != null && addressController.addressList!.isNotEmpty ? TextButton.icon(
                    ...
                    label: Text('add_new_address'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor)),
                  ) : const SizedBox(),
