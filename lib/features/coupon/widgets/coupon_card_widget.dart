...
class CouponCardWidget extends StatelessWidget {
  ...
  final int index;
  const CouponCardWidget({super.key, required this.coupon, required this.index});
          ...
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Text(
                ...
                style: AlmaraiMedium.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall),
              ...
              Row(children: [
                Text(
                  '*${'min_purchase'.tr} ',
                  style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeExtraSmall),
                  maxLines: 2, overflow: TextOverflow.ellipsis,
                ),
                const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                Text(
                  PriceConverter.convertPrice(coupon.minPurchase),
                  style: AlmaraiMedium.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeExtraSmall),
      ...
      ResponsiveHelper.isDesktop(context) ? Positioned(
        ...
        child: JustTheTooltip(
          ...
          content: Padding(
            ...
            child: Text('code_copied'.tr,style: AlmaraiRegular.copyWith(color: Theme.of(context).primaryColor)),
          ),
          child: InkWell(
            onTap: () async {
