                        ...
                        child: widget.success ? Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                          ...
                          SizedBox(
                            ...
                            child: RichText(
                              ...
                              text: TextSpan(style: AlmaraiRegular.copyWith(color: Theme.of(context).hintColor, height: 1.7), children: [
                          ...
                          SizedBox(
                            ...
                            child: Text(
                              ...
                              style: AlmaraiRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeDefault),
                              textAlign: TextAlign.center,
                            ),
                          ),
