        ...
        Positioned(
          ...
          child: Column(children: [
            ...
            Text(
              ...
              style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: canSelect ? Theme.of(context).cardColor : Colors.cyan.shade700),
            ),
            const SizedBox(height: Dimensions.paddingSizeSmall),

            Text(
              PriceConverter.convertPrice(packages.price),
              style: AlmaraiBold.copyWith(fontSize: 35, color: canSelect ? Theme.of(context).cardColor : Colors.cyan.shade700),
            ),

            Text('${packages.validity}' 'days'.tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
