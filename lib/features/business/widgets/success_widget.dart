      ...
      return Center(
        child: Container(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.start, children: [
            ...
            Text('congratulations'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeOverLarge)),
            const SizedBox(height: Dimensions.paddingSizeSmall),

            Text(
              'your_registration_has_been_completed_successfully'.tr,
              style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeSmall), textAlign: TextAlign.center, softWrap: true,
            ),
