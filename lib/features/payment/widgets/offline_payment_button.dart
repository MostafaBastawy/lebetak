        ...
        child: Column(children: [
            ...
            JustTheTooltip(
              ...
              content: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text('note'.tr, style: AlmaraiMedium.copyWith(color: const Color(0xff90D0FF))),
          ...
          isSelected ? GridView.builder(
            ...
            itemBuilder: (context, index) {
              bool isSelected = !forParcel ? checkoutController.selectedOfflineBankIndex == index : parcelController?.selectedOfflineBankIndex == index;
              return Container(
                decoration: BoxDecoration(
                ...
                child: CustomInkWell(
                  ...
                  child: Center(child: Text(offlineMethodList![index].methodName!,
                    style: AlmaraiMedium.copyWith(color: isSelected ? Theme.of(context).cardColor : Theme.of(context).textTheme.bodyMedium!.color!),
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        Expanded(child: Text(note, style: AlmaraiRegular.copyWith(color: Theme.of(context).cardColor))),
      ],
    );
  }
}
