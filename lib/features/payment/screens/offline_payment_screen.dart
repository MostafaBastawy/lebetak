                ...
                child: FooterView(
                  child: SizedBox(
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      Text('pay_your_bill_using_the_info'.tr, textAlign: TextAlign.center, style: AlmaraiRegular.copyWith(
                      ...
                      Padding(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Align(
                            ...
                            child: Text(
                              'payment_info'.tr,
                              style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeDefault),
                            ),
                          ),
          ...
          if(complete) {
            ...
            if(widget.forParcel) {
              ...
              orderId = await Get.find<CheckoutController>().placeOrder(
                  widget.placeOrderBody, widget.zoneId, widget.total, widget.maxCodOrderAmount, widget.fromCart,
                  widget.isCashOnDeliveryActive, Get.find<CheckoutController>().pickedPrescriptions, isOfflinePay: true);
            }
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
          Row(children: [
            Text('bank_info'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor)),
            const Spacer(),

            selected ? Row(children: [
              Text('pay_on_this_account'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor),),
            ...
            return Padding(
              ...
              child: Row(children: [
                Text(
                  ...
                  style: AlmaraiMedium.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color!.withValues(alpha: 0.5)),
                ),
                Flexible(child: Text(offlineMethodList[index].methodFields![i].inputData!, style: AlmaraiMedium, overflow: TextOverflow.ellipsis)),
              ]),
            );
          })
