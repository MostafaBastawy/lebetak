            ...
            ResponsiveHelper.isDesktop(context) ? Center(child: SizedBox(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(
                  ...
                  style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).hintColor),
                ),
                    ...
                    Visibility(
                      ...
                      child: Form(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Text('vendor_info'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                              ...
                              SizedBox(
                                ...
                                child: Align(
                                  ...
                                  child: TabBar(
                                    ...
                                    unselectedLabelStyle: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall),
                                    labelStyle: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).primaryColor),
                              ...
                              Row(children: [
                                ...
                                Expanded(flex: 4,
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    ...
                                    Row(children: [
                                      Text('vendor_logo'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.7))),
                                      Text(' (${'1:1'})', style: AlmaraiRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall)),
                                    ]),
                                    const SizedBox(height: Dimensions.paddingSizeDefault),
                                            ...
                                            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  ...
                                                  style: AlmaraiRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.7)), textAlign: TextAlign.center,
                                                ),
                                              ),
                                ...
                                Expanded(flex: 6,
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    ...
                                    Row(children: [
                                      Text('vendor_cover'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.7))),
                                      Text(' (${'3:1'})', style: AlmaraiRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall)),
                                    ]),
                                    const SizedBox(height: Dimensions.paddingSizeDefault),
                                            ...
                                            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  ...
                                                  style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor.withValues(alpha: 0.6), fontSize: Dimensions.fontSizeSmall),
                          ...
                          Text('location_info'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                          const SizedBox(height: Dimensions.paddingSizeDefault),
                          ...
                          Text('vendor_preference'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                          const SizedBox(height: Dimensions.paddingSizeDefault),
                                  ...
                                  children: [
                                    ...
                                    Positioned(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text('select_time'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor)),
                                      ),
                                    ),
                                  ],
                                ),
                    ...
                    Visibility(
                      ...
                      child: Form(
                        ...
                        child: Column(mainAxisAlignment: MainAxisAlignment.start, children: [
                          ...
                          Row(children: [
                            Text('owner_info'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                    ...
                    Visibility(
                      ...
                      child: Column(children: [
                        ...
                        Padding(
                          ...
                          child: Center(child: Text('choose_your_business_plan'.tr, style: AlmaraiBold)),
                        ),
                        ...
                        storeRegController.businessIndex == 0 ? Padding(
                          ...
                          child: Text(
                            ...
                            style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.7)), textAlign: TextAlign.justify, textScaler: const TextScaler.linear(1.1),
                          ),
                        ) : Column(children: [
                          Padding(
                            padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeLarge),
                            ...
                            child: storeRegController.packageModel!.packages!.isNotEmpty ? Swiper(
                              ...
                              onIndexChanged: (index) {
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: Dimensions.paddingSizeLarge),
                                  Text('no_package_available'.tr, style: AlmaraiMedium),
                                ]),
                            ),
    ...
    return Column(children: [
      ...
      storeRegController.storeStatus != 0.9 ? Column(children: [
        Row(children: [
          ...
          Text('vendor_information'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
        ]),
        const SizedBox(height: Dimensions.paddingSizeSmall),
            ...
            Row(children: [
              Container(
                ...
                child: TabBar(
                  ...
                  unselectedLabelColor: Theme.of(context).disabledColor,
                  unselectedLabelStyle: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall),
                  labelStyle: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor),
        ...
        Row(children: [
          ...
          const SizedBox(width: Dimensions.paddingSizeSmall),
          Text('general_information'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeDefault))
        ]),
        const SizedBox(height: Dimensions.paddingSizeSmall),
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          padding: const EdgeInsets.all(5),
                          child: Text('select_time'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeExtraSmall)),
                        ),
                      ),
                    ],
                  ),
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                ...
                                style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.7)), textAlign: TextAlign.center,
                              ),
                            ),
                            ...
                            Padding(
                              ...
                              child: Text(
                                'upload_jpg_png_gif_maximum_2_mb'.tr,
                                style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor.withValues(alpha: 0.6), fontSize: Dimensions.fontSizeOverSmall),
                                textAlign: TextAlign.center,
                              ),
                            ),
                        ...
                        child: storeRegController.pickedCover != null ? GetPlatform.isWeb ? Image.network(
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            Text(
                              ...
                              style: AlmaraiRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.7), fontSize: Dimensions.fontSizeExtraSmall), textAlign: TextAlign.center,
                            ),
        ...
        Form(
          ...
          child: Row(children: [
            const Icon(Icons.person),
            const SizedBox(width: Dimensions.paddingSizeSmall),
            Text('owner_information'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeDefault))
          ]),
        ),
        const SizedBox(height: Dimensions.paddingSizeSmall),
        ...
        Row(children: [
          ...
          const SizedBox(width: Dimensions.paddingSizeSmall),
          Text('login_info'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeDefault))
        ]),
        const SizedBox(height: Dimensions.paddingSizeSmall),
