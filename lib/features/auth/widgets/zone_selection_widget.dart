    ...
    return storeRegController.zoneIds != null ? Stack(clipBehavior: Clip.none, children: [
      ...
      Positioned(
        ...
        child: Container(
          ...
          child: Text('select_zone'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: isDesktop ? Dimensions.fontSizeExtraSmall : Dimensions.fontSizeDefault)),
        ),
      ),
