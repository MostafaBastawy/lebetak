      ...
      return Column(
        ...
        children: [
          canGoogleAndFacebookLogin ? Column(children: [
            ...
            showWelcomeText ? Text('${'welcome_to'.tr} ${AppConstants.appName}', style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge)) : const SizedBox(),
              ...
              child: CustomInkWell(
                ...
                child: Padding(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    Text('continue_with_google'.tr, style: AlmaraiMedium.copyWith()),
                  ]),
                ),
              ),
            ) : const SizedBox(),
              ...
              child: CustomInkWell(
                ...
                child: Padding(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    Text('continue_with_facebook'.tr, style: AlmaraiMedium.copyWith()),
                  ]),
                ),
              ),
            ) : const SizedBox(),
              ...
              child: CustomInkWell(
                ...
                child: Padding(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    Text('continue_with_apple'.tr, style: AlmaraiMedium.copyWith()),
                  ]),
                ),
              ),
            ) : const SizedBox(),
      ...
      Padding(
        ...
        child: Row(children: [
          ...
          Padding(
            ...
            child: Text('or_continue_with'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).disabledColor)),
          ),
          Expanded(child: Container(height: 1, color: Theme.of(context).disabledColor)),
        ]),
      ),
