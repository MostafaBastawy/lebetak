      ...
      builder: (authController) {
        return !authController.guestLoading ? TextButton(
          ...
          child: RichText(text: TextSpan(children: [
            TextSpan(text: '${'continue_as'.tr} ', style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor)),
            TextSpan(text: 'guest'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color)),
          ])),
