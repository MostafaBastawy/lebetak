        ...
        child: GetBuilder<StoreRegistrationController>(
          builder: (storeRegController) {
            return Column(
              ...
              children: [
                Text(isRental ? 'estimated_pickup_time_time'.tr : 'estimated_delivery_time'.tr , style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
