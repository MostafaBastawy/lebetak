    ...
    return GetBuilder<AuthController>(builder: (authController) {
      ...
      return Column(mainAxisSize: MainAxisSize.min, children: [
        Align(
          ...
          child: Text('login'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),
        ),
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          InkWell(
            ...
            child: Row(
              ...
              children: [
                ...
                Text('remember_me'.tr, style: AlmaraiRegular),
              ],
            ),
          ),
          ...
          TextButton(
            ...
            child: Text('${'forgot_password'.tr}?', style: AlmaraiRegular.copyWith(color: Theme.of(context).primaryColor)),
          ),
        ]),
        ...
        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Text('do_not_have_account'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).hintColor)),
          ...
          InkWell(
            ...
            child: Padding(
              ...
              child: Text('sign_up'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor)),
            ),
          ),
        ]),
        ...
        onOtpViewClick != null ? Column(children: [
          Text('or'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor)),
          const SizedBox(height: Dimensions.paddingSizeExtraSmall),

          Row(mainAxisSize: MainAxisSize.min, children: [
            Text('sign_in_with'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor)),
            const SizedBox(width: Dimensions.paddingSizeExtraSmall),

            InkWell(
              onTap: onOtpViewClick,
              child: Text('otp'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).primaryColor, decoration: TextDecoration.underline)),
            ),
          ]),
        ]) : const SizedBox(),
          ...
          child: Column(children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              InkWell(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text('remember_me'.tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                  ],
                ),
              ),
              ...
              TextButton(
                ...
                child: Text('${'forgot_password'.tr}?', style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor)),
              ),
            ]),
            ...
            child: CustomInkWell(
              ...
              child: Padding(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text('otp_sign_in'.tr, style: AlmaraiMedium.copyWith()),
                ]),
              ),
            ),
          ) : const SizedBox(),
