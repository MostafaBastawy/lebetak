  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text(userModel.name ?? 'Jhon Doe', style: AlmaraiMedium, textAlign: TextAlign.center),
        const SizedBox(height: Dimensions.paddingSizeLarge),

        Text('is_it_you'.tr, style: AlmaraiBold, textAlign: TextAlign.center),
        const SizedBox(height: Dimensions.paddingSizeSmall),

        RichText(
          textAlign: TextAlign.center,
          text: TextSpan(children: [
            TextSpan(text: number != null ? 'it_looks_like_the_phone'.tr : 'it_looks_like_the_email'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor)),
            const TextSpan(text: ' '),

            TextSpan(text: number ?? email, style: AlmaraiMedium.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color)),
            const TextSpan(text: ' '),
