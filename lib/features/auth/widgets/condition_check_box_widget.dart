...
class ConditionCheckBoxWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(mainAxisAlignment: MainAxisAlignment.start, children: [
      ...
      forDeliveryMan ? const SizedBox() : Text( '* ', style: AlmaraiRegular.copyWith(color: Theme.of(context).hintColor)),
        ...
        child: RichText(
          text: TextSpan(children: [
            TextSpan(
              ...
              style: AlmaraiRegular.copyWith(color: forDeliveryMan ? Theme.of(context).textTheme.bodyMedium!.color : Theme.of(context).hintColor, fontSize: forDeliveryMan ? Dimensions.fontSizeDefault : Dimensions.fontSizeSmall),
            ),
            const TextSpan(text: ' '),
            TextSpan(
