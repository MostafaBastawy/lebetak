            ...
            Padding(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  isDesktop ? Align(
                    ...
                    child: Text('sign_up'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),
                  ) : const SizedBox(),
                ...
                SizedBox(height: isDesktop ? Dimensions.paddingSizeExtraLarge : Dimensions.paddingSizeLarge),
                  ...
                  Padding(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      Text('already_have_account'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).hintColor)),
