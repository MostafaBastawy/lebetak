          ...
          child: SingleChildScrollView(
            child: isDesktop && widget.fromView ? webView(storeRegController, zoneList): Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              !storeRegController.inZone ? Padding(
                ...
                child: Row(children: [
                  Text('* ', style: AlmaraiBold.copyWith(color: Colors.red)),
                  Text('please_place_the_marker_inside_the_zone'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).colorScheme.error)),
                ]),
              ) : const SizedBox(),
             ...
             Positioned(
               ...
               child: InkWell(
                 ...
                 child: Container(
                   ...
                   child: Text('search'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).hintColor)),
                 ),
               ),
            ),
