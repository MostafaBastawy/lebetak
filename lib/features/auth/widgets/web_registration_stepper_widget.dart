        ...
        Row(children: [
          ...
          Stack(
            ...
            children: [
              ...
              (onGoing || processing || rightActive) ? const SizedBox() : Positioned(
                ...
                child: Center(child: Text( state == 1 ? '' : state == 2 ? '2' : '3', style: AlmaraiMedium.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeSmall),)),
              ),
            ],
          ),
          ...
          Padding(
            ...
            child: Text(
              ...
              style: AlmaraiRegular.copyWith(color: (onGoing || processing || rightActive) ? Theme.of(context).textTheme.bodyLarge?.color : Theme.of(context).disabledColor),
            ),
          ),
