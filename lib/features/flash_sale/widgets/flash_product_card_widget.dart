              ...
              ResponsiveHelper.isDesktop(context) ? Positioned(
                ...
                child: remaining == 0 ? Center(
                  child: Container(
                    ...
                    child: Text('sold_out'.tr, style: AlmaraiMedium.copyWith(color: Colors.red)),
                  ),
                ) : CartCountView(
                  item: product.item!,
                  index: index,
          ...
          Expanded(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(product.item!.name ?? '', maxLines: 2, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center, style: AlmaraiMedium),
                  ...
                  ResponsiveHelper.isMobile(context) ? const SizedBox() : Row(children: [
                    Text('${'available'.tr} : ', style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor)),
                    Text('$remaining ${'item'.tr}', style: AlmaraiRegular.copyWith(color: Theme.of(context).primaryColor)),
                  ]),
