                 ...
                 child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                   ...
                   Expanded(child: Padding(
                     ...
                     child: Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.start, children: [
                       Text('choose_your_language'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                       Text('choose_your_language_to_proceed'.tr, style: AlmaraiRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
