                                      ...
                                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                        ...
                                        Padding(
                                          ...
                                          child: TextButton.icon(
                                            ...
                                            label: Text('add_more_items'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeDefault)),
                                          ),
                                        ),
                    ...
                    Container(
                      ...
                      child: Column(children: [
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text('item_price'.tr, style: AlmaraiRegular),
                          PriceConverter.convertAnimationPrice(cartController.itemPrice, textStyle: AlmaraiRegular),
                        ]),
                        ...
                        cartController.variationPrice > 0 && ModuleHelper.getModuleConfig(cartController.cartList.first.item!.moduleType).newVariation! ? Row(
                          ...
                          children: [
                            Text('variations'.tr, style: AlmaraiRegular),
                            Text(
                              '(+) ${PriceConverter.convertPrice(cartController.variationPrice)}',
                              style: AlmaraiRegular, textDirection: TextDirection.ltr,
                            ),
                          ],
                        ) : const SizedBox(),
                        const SizedBox(height: Dimensions.paddingSizeSmall),
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text('discount'.tr, style: AlmaraiRegular),
                          storeController.store != null ? Row(children: [
                            Text('(-)', style: AlmaraiRegular),
                            PriceConverter.convertAnimationPrice(cartController.itemDiscountPrice, textStyle: AlmaraiRegular),
                          ]) : Text('calculating'.tr, style: AlmaraiRegular),
                        ]),
                        ...
                        Get.find<SplashController>().configModel!.moduleConfig!.module!.addOn! ? Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text('addons'.tr, style: AlmaraiRegular),
                            Row(children: [
                              Text('(+)', style: AlmaraiRegular),
                              PriceConverter.convertAnimationPrice(cartController.addOns, textStyle: AlmaraiRegular),
                            ]),
                          ],
                        ) : const SizedBox(),
          ...
          return Column(children: [
            ...
            ResponsiveHelper.isDesktop(context) ? Align(
              ...
              child: Padding(
                ...
                child: Text('order_summary'.tr, style: AlmaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
              ),
            ) : const SizedBox(),
            ...
            && (storeController.store != null && storeController.store!.cutlery!) ? Padding(
              ...
              child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                ...
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('add_cutlery'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor)),
                    const SizedBox(height: Dimensions.paddingSizeExtraSmall),

                    Text('do_not_have_cutlery'.tr, style: AlmaraiRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall)),
                  ]),
                ),
              ...
              child: Column(
                ...
                children: [
                  InkWell(
                    ...
                    child: Row(children: [
                      Expanded(child: Text('if_any_product_is_not_available'.tr, style: AlmaraiMedium, maxLines: 2, overflow: TextOverflow.ellipsis)),
                      const Icon(Icons.arrow_forward_ios_sharp, size: 18),
                    ]),
                  ),

                  cartController.notAvailableIndex != -1 ? Row(children: [
                    Text(cartController.notAvailableList[cartController.notAvailableIndex].tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor)),
            ...
            ResponsiveHelper.isDesktop(context) ? Padding(
              ...
              child: Column(children: [
                ...
                Get.find<SplashController>().getModuleConfig(item.moduleType).newVariation! && cartController.variationPrice > 0 ? Row(
                  ...
                  children: [
                    Text('variations'.tr, style: AlmaraiRegular),
                    Text('(+) ${PriceConverter.convertPrice(cartController.variationPrice)}', style: AlmaraiRegular, textDirection: TextDirection.ltr),
                  ],
                ) : const SizedBox(),
                const SizedBox(height: Dimensions.paddingSizeSmall),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  // Text('(-) ${PriceConverter.convertPrice(cartController.itemDiscountPrice)}', style: AlmaraiRegular, textDirection: TextDirection.ltr),
                ]),
                ...
                Get.find<SplashController>().configModel!.moduleConfig!.module!.addOn! ? Row(
                  ...
                  children: [
                    Text('addons'.tr, style: AlmaraiRegular),
                    Text('(+) ${PriceConverter.convertPrice(cartController.addOns)}', style: AlmaraiRegular, textDirection: TextDirection.ltr),
                  ],
                ) : const SizedBox(),
              ]),
            ) : const SizedBox(),
          ...
          return storeController.cartSuggestItemModel != null && suggestedItems!.isNotEmpty ? Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text('you_may_also_like'.tr, style: AlmaraiMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
              ),
            ...
            children: [
              ...
              ? Column(children: [
                  Row(children: [
                    ...
                    Text(
                      ...
                      style: AlmaraiMedium.copyWith(color: Theme.of(context).primaryColor), textDirection: TextDirection.ltr,
                    ),
                    const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                    Text('more_for_free_delivery'.tr, style: AlmaraiMedium.copyWith(color: Theme.of(context).disabledColor)),
                  ]),
                const SizedBox(height: Dimensions.paddingSizeExtraSmall),
              ...
              Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('subtotal'.tr, style: AlmaraiMedium.copyWith(color:  ResponsiveHelper.isDesktop(context) ? Theme.of(context).textTheme.bodyLarge!.color : Theme.of(context).primaryColor)),
                    PriceConverter.convertAnimationPrice(cartController.subTotal, textStyle: AlmaraiRegular.copyWith(color: Theme.of(context).primaryColor)),
                    // Text(
                    //   PriceConverter.convertPrice(cartController.subTotal),
                    //   style: AlmaraiMedium.copyWith(color: ResponsiveHelper.isDesktop(context) ? Theme.of(context).textTheme.bodyLarge!.color : Theme.of(context).primaryColor), textDirection: TextDirection.ltr,
                    // ),
                  ],
                ),
              ),
